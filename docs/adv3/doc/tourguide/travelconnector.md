...
**isConnectorListed:** Is this connector listed? This indicates whether
...
**darkTravel (actor, dest):** Handle travel in the dark. Specifically,
...
**getApparentDestination (origin, actor)**: Get the apparent destination
