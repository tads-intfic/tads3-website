...
layout: docs
---
<span class="title">predicate(Dig)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Dig)`</span>` :   `[`DigAction`](../object/DigAction.html)*`// after macro expansion`*
