---
---
<span class="title">SwitchAction</span><span class="type">class</span>
...
`DefineTAction(Switch)      `*`// original source text`*  
`class `**`SwitchAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
