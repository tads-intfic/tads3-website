...
layout: docs
---
<span class="title">Intangible</span><span class="type">class</span>
...
`touchPresence`<span class="rem">OVERRIDDEN</span>
...
intangible; to re-enable an action, just define a verify() handler for
the action.
