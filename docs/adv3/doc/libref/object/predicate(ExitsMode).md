...
layout: docs
---
<span class="title">predicate(ExitsMode)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ExitsMode)`</span>` :   `[`ExitsModeAction`](../object/ExitsModeAction.html)*`// after macro expansion`*
...
Inherited from `ExitsModeAction` :  
