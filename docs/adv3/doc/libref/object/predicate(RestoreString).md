...
layout: docs
---
<span class="title">predicate(RestoreString)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(RestoreString)`</span>` :   `[`RestoreStringAction`](../object/RestoreStringAction.html)*`// after macro expansion`*
...
Inherited from `RestoreAction` :  
[`askAndRestore`](../object/RestoreAction.html#askAndRestore)[`performRestore`](../object/RestoreAction.html#performRestore)[`startupRestore`](../object/RestoreAction.html#startupRestore)
