...
layout: docs
---
<span class="title">predicate(TurnOn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TurnOn)`</span>` :   `[`TurnOnAction`](../object/TurnOnAction.html)*`// after macro expansion`*
