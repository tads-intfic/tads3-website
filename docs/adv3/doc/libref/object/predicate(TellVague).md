...
layout: docs
---
<span class="title">predicate(TellVague)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TellVague)`</span>` :   `[`AskVagueAction`](../object/AskVagueAction.html)*`// after macro expansion`*
