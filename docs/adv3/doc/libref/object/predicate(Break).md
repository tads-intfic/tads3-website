...
layout: docs
---
<span class="title">predicate(Break)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Break)`</span>` :   `[`BreakAction`](../object/BreakAction.html)*`// after macro expansion`*
