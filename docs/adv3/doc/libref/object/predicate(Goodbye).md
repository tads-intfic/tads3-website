---
---
<span class="title">predicate(Goodbye)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Goodbye)`</span>` :   `[`GoodbyeAction`](../object/GoodbyeAction.html)`      `*`// after macro expansion`*
...
Inherited from `GoodbyeAction` :  
` `[`execAction`](../object/GoodbyeAction.html#execAction)`  `
