...
layout: docs
---
<span class="title">predicate(Save)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Save)`</span>` :   `[`SaveAction`](../object/SaveAction.html)*`// after macro expansion`*
