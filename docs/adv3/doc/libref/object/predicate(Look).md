...
layout: docs
---
<span class="title">predicate(Look)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Look)`</span>` :   `[`LookAction`](../object/LookAction.html)`      `*`// after macro expansion`*
...
Inherited from `LookAction` :  
` `[`execAction`](../object/LookAction.html#execAction)`  `
