...
layout: docs
---
<span class="title">ReplayStringAction</span><span class="type">class</span>
...
`DefineAction(ReplayString, ReplayAction)      `*`// original source text`*  
`class `**`ReplayStringAction`**` :   `[`ReplayAction`](../object/ReplayAction.html)*`// after macro expansion`*
