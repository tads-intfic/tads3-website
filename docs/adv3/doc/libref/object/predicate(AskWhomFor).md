...
layout: docs
---
<span class="title">predicate(AskWhomFor)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(AskWhomFor)`</span>` :   `[`AskForAction`](../object/AskForAction.html)*`// after macro expansion`*
