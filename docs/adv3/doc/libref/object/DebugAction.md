<span class="title">DebugAction</span><span class="type">class</span>
...
`DefineIAction(Debug)      `*`// original source text`*  
`class `**`DebugAction`**` :   `[`IAction`](../object/IAction.html)`      `*`// after macro expansion`*
