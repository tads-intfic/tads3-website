...
layout: docs
---
<span class="title">predicate(ShowToWhom)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ShowToWhom)`</span>` :   `[`ShowToAction`](../object/ShowToAction.html)*`// after macro expansion`*
