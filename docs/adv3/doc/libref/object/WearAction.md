---
---
<span class="title">WearAction</span><span class="type">class</span>
...
`DefineTAction(Wear)      `*`// original source text`*  
`class `**`WearAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
