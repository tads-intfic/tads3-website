...
layout: docs
---
<span class="title">AboutAction</span><span class="type">class</span>
...
`DefineSystemAction(About)      `*`// original source text`*  
`class `**`AboutAction`**` :   `[`SystemAction`](../object/SystemAction.html)*`// after macro expansion`*
