...
layout: docs
---
<span class="title">PushInAction</span><span class="type">class</span>
...
`DefineAction(PushIn, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushInAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)*`// after macro expansion`*
