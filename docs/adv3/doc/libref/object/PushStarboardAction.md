...
`DefineAction(PushStarboard, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushStarboardAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)*`// after macro expansion`*
