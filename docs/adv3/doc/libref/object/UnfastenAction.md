...
layout: docs
---
<span class="title">UnfastenAction</span><span class="type">class</span>
...
`DefineTAction(Unfasten)      `*`// original source text`*  
`class `**`UnfastenAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
