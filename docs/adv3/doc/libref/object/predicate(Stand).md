...
layout: docs
---
<span class="title">predicate(Stand)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Stand)`</span>` :   `[`StandAction`](../object/StandAction.html)*`// after macro expansion`*
...
Inherited from `StandAction` :  
[`execAction`](../object/StandAction.html#execAction)
