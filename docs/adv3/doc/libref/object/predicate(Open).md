...
layout: docs
---
<span class="title">predicate(Open)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Open)`</span>` :   `[`OpenAction`](../object/OpenAction.html)*`// after macro expansion`*
