...
layout: docs
---
<span class="title">UnlockWithAction</span><span class="type">class</span>
...
`DefineTIAction(UnlockWith)      `*`// original source text`*  
`class `**`UnlockWithAction`**` :   `[`TIAction`](../object/TIAction.html)*`// after macro expansion`*
