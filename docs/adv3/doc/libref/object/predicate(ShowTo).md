<span class="title">predicate(ShowTo)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ShowTo)`</span>` :   `[`ShowToAction`](../object/ShowToAction.html)`      `*`// after macro expansion`*
