...
layout: docs
---
<span class="title">StandAction</span><span class="type">class</span>
...
`DefineIAction(Stand)      `*`// original source text`*  
`class `**`StandAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
