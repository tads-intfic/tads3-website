...
layout: docs
---
<span class="title">predicate(FullScore)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(FullScore)`</span>` :   `[`FullScoreAction`](../object/FullScoreAction.html)*`// after macro expansion`*
...
Inherited from `FullScoreAction` :  
...
Inherited from `FullScoreAction` :  
[`execSystemAction`](../object/FullScoreAction.html#execSystemAction) [`showFullScore`](../object/FullScoreAction.html#showFullScore)
