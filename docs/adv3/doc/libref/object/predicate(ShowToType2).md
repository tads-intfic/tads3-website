...
layout: docs
---
<span class="title">predicate(ShowToType2)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ShowToType2)`</span>` :   `[`ShowToAction`](../object/ShowToAction.html)`      `*`// after macro expansion`*
...
`isPrepositionalPhrasing`<span class="rem">OVERRIDDEN</span>
