...
layout: docs
---
<span class="title">predicate(Sleep)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Sleep)`</span>` :   `[`SleepAction`](../object/SleepAction.html)*`// after macro expansion`*
...
Inherited from `SleepAction` :  
[`execAction`](../object/SleepAction.html#execAction)
