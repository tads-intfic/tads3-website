...
layout: docs
---
<span class="title">predicate(GoBack)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(GoBack)`</span>` :   `[`GoBackAction`](../object/GoBackAction.html)*`// after macro expansion`*
...
Inherited from `GoBackAction` :  
[`execAction`](../object/GoBackAction.html#execAction)
