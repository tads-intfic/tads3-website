...
layout: docs
---
<span class="title">predicate(Turn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Turn)`</span>` :   `[`TurnAction`](../object/TurnAction.html)*`// after macro expansion`*
