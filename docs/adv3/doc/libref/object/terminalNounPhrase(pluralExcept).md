...
layout: docs
---
<span class="title">terminalNounPhrase(pluralExcept)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`terminalNounPhrase`](../object/terminalNounPhrase.html)`(pluralExcept)`</span>` :   `[`ListButProd`](../object/ListButProd.html)
