---
---
<span class="title">ListenToAction</span><span class="type">class</span>
...
`DefineTAction(ListenTo)      `*`// original source text`*  
`class `**`ListenToAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
