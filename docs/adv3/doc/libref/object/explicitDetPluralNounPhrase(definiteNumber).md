...
layout: docs
---
<span class="title">explicitDetPluralNounPhrase(definiteNumber)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`explicitDetPluralNounPhrase`](../object/explicitDetPluralNounPhrase.html)`(definiteNumber)`</span>` :   `[`ExactQuantifiedPluralProd`](../object/ExactQuantifiedPluralProd.html)
