---
---
<span class="title">predicate(PutUnder)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PutUnder)`</span>` :   `[`PutUnderAction`](../object/PutUnderAction.html)`      `*`// after macro expansion`*
