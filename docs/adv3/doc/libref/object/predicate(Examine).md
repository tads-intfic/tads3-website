...
layout: docs
---
<span class="title">predicate(Examine)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Examine)`</span>` :   `[`ExamineAction`](../object/ExamineAction.html)`      `*`// after macro expansion`*
