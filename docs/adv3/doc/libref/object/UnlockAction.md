...
layout: docs
---
<span class="title">UnlockAction</span><span class="type">class</span>
...
`DefineTAction(Unlock)      `*`// original source text`*  
`class `**`UnlockAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
