...
layout: docs
---
<span class="title">predicate(GetOutOf)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(GetOutOf)`</span>` :   `[`GetOutOfAction`](../object/GetOutOfAction.html)*`// after macro expansion`*
...
`adjustDefaultObjectPrep (prep, obj)`<span class="rem">OVERRIDDEN</span>
