---
---
<span class="title">VerboseAction</span><span class="type">class</span>
...
`DefineSystemAction(Verbose)      `*`// original source text`*  
`class `**`VerboseAction`**` :   `[`SystemAction`](../object/SystemAction.html)`      `*`// after macro expansion`*
