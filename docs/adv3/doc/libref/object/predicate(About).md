...
layout: docs
---
<span class="title">predicate(About)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(About)`</span>` :   `[`AboutAction`](../object/AboutAction.html)*`// after macro expansion`*
