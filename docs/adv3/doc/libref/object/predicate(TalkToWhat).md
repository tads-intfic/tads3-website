...
layout: docs
---
<span class="title">predicate(TalkToWhat)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TalkToWhat)`</span>` :   `[`TalkToAction`](../object/TalkToAction.html)*`// after macro expansion`*
