...
layout: docs
---
<span class="title">predicate(VagueTravel)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(VagueTravel)`</span>` :   `[`VagueTravelAction`](../object/VagueTravelAction.html)`      `*`// after macro expansion`*
...
Inherited from `VagueTravelAction` :  
` `[`execAction`](../object/VagueTravelAction.html#execAction)`  `
