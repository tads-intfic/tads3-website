...
layout: docs
---
<span class="title">predicate(MoveWith)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(MoveWith)`</span>` :   `[`MoveWithAction`](../object/MoveWithAction.html)`      `*`// after macro expansion`*
...
Inherited from `MoveWithAction` :  
` `[`getAllIobj`](../object/MoveWithAction.html#getAllIobj)`  `
