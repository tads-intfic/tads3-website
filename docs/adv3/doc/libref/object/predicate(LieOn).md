...
layout: docs
---
<span class="title">predicate(LieOn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(LieOn)`</span>` :   `[`LieOnAction`](../object/LieOnAction.html)*`// after macro expansion`*
