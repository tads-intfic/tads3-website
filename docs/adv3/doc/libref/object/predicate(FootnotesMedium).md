...
layout: docs
---
<span class="title">predicate(FootnotesMedium)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(FootnotesMedium)`</span>` :   `[`FootnotesMediumAction`](../object/FootnotesMediumAction.html)*`// after macro expansion`*
...
Inherited from `FootnotesMediumAction` :  
