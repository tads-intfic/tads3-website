...
layout: docs
---
<span class="title">YellAction</span><span class="type">class</span>
...
`DefineIAction(Yell)      `*`// original source text`*  
`class `**`YellAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
