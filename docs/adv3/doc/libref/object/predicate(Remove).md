...
layout: docs
---
<span class="title">predicate(Remove)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Remove)`</span>` :   `[`RemoveAction`](../object/RemoveAction.html)`      `*`// after macro expansion`*
