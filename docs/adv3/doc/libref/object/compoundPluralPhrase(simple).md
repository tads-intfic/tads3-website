---
---
<span class="title">compoundPluralPhrase(simple)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`compoundPluralPhrase`](../object/compoundPluralPhrase.html)`(simple)`</span>` :   `[`NounPhraseWithVocab`](../object/NounPhraseWithVocab.html)
