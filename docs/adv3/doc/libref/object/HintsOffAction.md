...
layout: docs
---
<span class="title">HintsOffAction</span><span class="type">class</span>
...
`DefineSystemAction(HintsOff)      `*`// original source text`*  
`class `**`HintsOffAction`**` :   `[`SystemAction`](../object/SystemAction.html)*`// after macro expansion`*
