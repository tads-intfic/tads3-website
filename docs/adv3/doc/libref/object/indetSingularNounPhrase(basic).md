...
layout: docs
---
<span class="title">indetSingularNounPhrase(basic)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`indetSingularNounPhrase`](../object/indetSingularNounPhrase.html)`(basic)`</span>` :   `[`LayeredNounPhraseProd`](../object/LayeredNounPhraseProd.html)
