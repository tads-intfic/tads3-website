...
Plain lister for actors. This is the same as an ordinary plainLister,
but ignores each object's isListed flag and lists it anyway.

**`plainActorLister`**` :   `[`plainLister`](../object/plainLister.html)
...
**`plainActorLister`**  
[`plainLister`](../object/plainLister.html)  
...
Inherited from `plainLister` :  
[`showListPrefixTall`](../object/plainLister.html#showListPrefixTall)[`showListPrefixWide`](../object/plainLister.html#showListPrefixWide)[`showListSuffixWide`](../object/plainLister.html#showListSuffixWide)
