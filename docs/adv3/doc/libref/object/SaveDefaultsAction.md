...
layout: docs
---
<span class="title">SaveDefaultsAction</span><span class="type">class</span>
...
`DefineSystemAction(SaveDefaults)      `*`// original source text`*  
`class `**`SaveDefaultsAction`**` :   `[`SystemAction`](../object/SystemAction.html)*`// after macro expansion`*
