...
layout: docs
---
<span class="title">singleNounOnly(main)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`singleNounOnly`](../object/singleNounOnly.html)`(main)`</span>` :   `[`SingleNounProd`](../object/SingleNounProd.html)
