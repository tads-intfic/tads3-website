...
layout: docs
---
<span class="title">predicate(Drop)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Drop)`</span>` :   `[`DropAction`](../object/DropAction.html)*`// after macro expansion`*
