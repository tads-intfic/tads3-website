---
---
<span class="title">predicate(TypeOn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TypeOn)`</span>` :   `[`TypeOnAction`](../object/TypeOnAction.html)`      `*`// after macro expansion`*
