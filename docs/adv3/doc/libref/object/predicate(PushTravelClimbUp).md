...
layout: docs
---
<span class="title">predicate(PushTravelClimbUp)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PushTravelClimbUp)`</span>` :   `[`PushTravelClimbUpAction`](../object/PushTravelClimbUpAction.html)*`// after macro expansion`*
...
Inherited from `PushTravelClimbUpAction` :  
