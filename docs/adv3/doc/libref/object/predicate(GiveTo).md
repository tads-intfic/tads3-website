<span class="title">predicate(GiveTo)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(GiveTo)`</span>` :   `[`GiveToAction`](../object/GiveToAction.html)`      `*`// after macro expansion`*
