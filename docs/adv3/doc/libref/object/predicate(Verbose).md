...
layout: docs
---
<span class="title">predicate(Verbose)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Verbose)`</span>` :   `[`VerboseAction`](../object/VerboseAction.html)`      `*`// after macro expansion`*
