...
layout: docs
---
<span class="title">predicate(PlugIn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PlugIn)`</span>` :   `[`PlugInAction`](../object/PlugInAction.html)*`// after macro expansion`*
