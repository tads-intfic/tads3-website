...
layout: docs
---
<span class="title">predicate(Search)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Search)`</span>` :   `[`SearchAction`](../object/SearchAction.html)*`// after macro expansion`*
