...
SimpleNoise is for cases where a noise is an ongoing part of a location,
so (1) it's not necessary to distinguish source and sourceless versions
of the description, and (2) there are no scheduled reports for the
noise. For these cases, all of the messages default to the basic 'desc'
property. Note that we make this type of noise "ambient" by default,
which means that we won't automatically include it in room descriptions.
...
[`isSoundListedInRoom`](../object/Noise.html#isSoundListedInRoom)[`soundPresence`](../object/Noise.html#soundPresence)

Inherited from `SensoryEmanation` :  
[`descWithoutSource`](../object/SensoryEmanation.html#descWithoutSource)[`descWithSource`](../object/SensoryEmanation.html#descWithSource)[`displayCount`](../object/SensoryEmanation.html#displayCount)[`displaySchedule`](../object/SensoryEmanation.html#displaySchedule)[`hereWithoutSource`](../object/SensoryEmanation.html#hereWithoutSource)[`hereWithSource`](../object/SensoryEmanation.html#hereWithSource)[`isEmanating`](../object/SensoryEmanation.html#isEmanating)[`nextDisplayTime`](../object/SensoryEmanation.html#nextDisplayTime)[`noiseList`](../object/SensoryEmanation.html#noiseList)[`noLongerHere`](../object/SensoryEmanation.html#noLongerHere)[`odorList`](../object/SensoryEmanation.html#odorList)[`scheduleIndex`](../object/SensoryEmanation.html#scheduleIndex)[`sourceDesc`](../object/SensoryEmanation.html#sourceDesc)

Inherited from `Intangible` :  
[`isListed`](../object/Intangible.html#isListed)[`isListedInContents`](../object/Intangible.html#isListedInContents)[`isListedInInventory`](../object/Intangible.html#isListedInInventory)[`sightPresence`](../object/Intangible.html#sightPresence)[`smellPresence`](../object/Intangible.html#smellPresence)[`touchPresence`](../object/Intangible.html#touchPresence)
...
Inherited from `Noise` :  
[`cannotSeeSource`](../object/Noise.html#cannotSeeSource)[`dobjFor(Examine)`](../object/Noise.html#dobjFor(Examine))[`dobjFor(ListenTo)`](../object/Noise.html#dobjFor(ListenTo))[`soundHereDesc`](../object/Noise.html#soundHereDesc)

Inherited from `SensoryEmanation` :  
[`calcNextDisplayTime`](../object/SensoryEmanation.html#calcNextDisplayTime)[`canSeeSource`](../object/SensoryEmanation.html#canSeeSource)[`continueEmanation`](../object/SensoryEmanation.html#continueEmanation)[`emanationHereDesc`](../object/SensoryEmanation.html#emanationHereDesc)[`endEmanation`](../object/SensoryEmanation.html#endEmanation)[`getSource`](../object/SensoryEmanation.html#getSource)[`noteDisplay`](../object/SensoryEmanation.html#noteDisplay)[`noteIndirectDisplay`](../object/SensoryEmanation.html#noteIndirectDisplay)[`noteSenseChanges`](../object/SensoryEmanation.html#noteSenseChanges)[`noteSenseChangesFor`](../object/SensoryEmanation.html#noteSenseChangesFor)[`startEmanation`](../object/SensoryEmanation.html#startEmanation)
...
`isAmbient`<span class="rem">OVERRIDDEN</span>
