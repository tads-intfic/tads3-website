---
---
<span class="title">YesAction</span><span class="type">class</span>
...
`DefineConvIAction(Yes)      `*`// original source text`*  
`class `**`YesAction`**` :   `[`ConvIAction`](../object/ConvIAction.html)`      `*`// after macro expansion`*
