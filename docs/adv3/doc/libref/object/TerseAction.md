---
---
<span class="title">TerseAction</span><span class="type">class</span>
...
`DefineSystemAction(Terse)      `*`// original source text`*  
`class `**`TerseAction`**` :   `[`SystemAction`](../object/SystemAction.html)`      `*`// after macro expansion`*
