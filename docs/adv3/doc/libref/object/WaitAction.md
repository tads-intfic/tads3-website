...
layout: docs
---
<span class="title">WaitAction</span><span class="type">class</span>
...
`DefineIAction(Wait)      `*`// original source text`*  
`class `**`WaitAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
