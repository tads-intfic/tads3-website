...
layout: docs
---
<span class="title">ThrowToAction</span><span class="type">class</span>
...
`DefineTIAction(ThrowTo)      `*`// original source text`*  
`class `**`ThrowToAction`**` :   `[`TIAction`](../object/TIAction.html)*`// after macro expansion`*
