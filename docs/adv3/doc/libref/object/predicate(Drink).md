---
---
<span class="title">predicate(Drink)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Drink)`</span>` :   `[`DrinkAction`](../object/DrinkAction.html)`      `*`// after macro expansion`*
