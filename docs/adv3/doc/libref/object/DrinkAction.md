...
layout: docs
---
<span class="title">DrinkAction</span><span class="type">class</span>
...
`DefineTAction(Drink)      `*`// original source text`*  
`class `**`DrinkAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
