<span class="title">predicate(SmellImplicit)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(SmellImplicit)`</span>` :   `[`SmellImplicitAction`](../object/SmellImplicitAction.html)`      `*`// after macro expansion`*
...
Inherited from `SmellImplicitAction` :  
` `[`defaultMsgProp`](../object/SmellImplicitAction.html#defaultMsgProp)`  `[`descProp`](../object/SmellImplicitAction.html#descProp)`  `[`mySense`](../object/SmellImplicitAction.html#mySense)`  `[`resultLister`](../object/SmellImplicitAction.html#resultLister)`  `
