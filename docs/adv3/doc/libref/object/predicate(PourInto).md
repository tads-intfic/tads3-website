...
layout: docs
---
<span class="title">predicate(PourInto)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PourInto)`</span>` :   `[`PourIntoAction`](../object/PourIntoAction.html)`      `*`// after macro expansion`*
