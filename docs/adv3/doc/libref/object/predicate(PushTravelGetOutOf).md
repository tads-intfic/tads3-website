...
layout: docs
---
<span class="title">predicate(PushTravelGetOutOf)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PushTravelGetOutOf)`</span>` :   `[`PushTravelGetOutOfAction`](../object/PushTravelGetOutOfAction.html)*`// after macro expansion`*
