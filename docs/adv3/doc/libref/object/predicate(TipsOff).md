...
layout: docs
---
<span class="title">predicate(TipsOff)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TipsOff)`</span>` :   `[`TipModeAction`](../object/TipModeAction.html)*`// after macro expansion`*
...
[`stat_`](#stat_)[`verbPhrase`](#verbPhrase)
