...
layout: docs
---
<span class="title">predicate(GetOut)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(GetOut)`</span>` :   `[`GetOutAction`](../object/GetOutAction.html)*`// after macro expansion`*
...
Inherited from `GetOutAction` :  
[`execAction`](../object/GetOutAction.html#execAction)
