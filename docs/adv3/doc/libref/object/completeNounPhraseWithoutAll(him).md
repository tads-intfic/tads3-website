...
layout: docs
---
<span class="title">completeNounPhraseWithoutAll(him)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`completeNounPhraseWithoutAll`](../object/completeNounPhraseWithoutAll.html)`(him)`</span>` :   `[`HimProd`](../object/HimProd.html)
