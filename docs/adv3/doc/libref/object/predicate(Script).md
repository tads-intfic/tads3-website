...
layout: docs
---
<span class="title">predicate(Script)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Script)`</span>` :   `[`ScriptAction`](../object/ScriptAction.html)*`// after macro expansion`*
