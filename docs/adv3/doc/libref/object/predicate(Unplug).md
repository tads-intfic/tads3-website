...
layout: docs
---
<span class="title">predicate(Unplug)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Unplug)`</span>` :   `[`UnplugAction`](../object/UnplugAction.html)*`// after macro expansion`*
