...
layout: docs
---
<span class="title">predicate(Unfasten)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Unfasten)`</span>` :   `[`UnfastenAction`](../object/UnfastenAction.html)*`// after macro expansion`*
