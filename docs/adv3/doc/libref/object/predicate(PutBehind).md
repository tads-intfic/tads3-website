...
layout: docs
---
<span class="title">predicate(PutBehind)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PutBehind)`</span>` :   `[`PutBehindAction`](../object/PutBehindAction.html)*`// after macro expansion`*
