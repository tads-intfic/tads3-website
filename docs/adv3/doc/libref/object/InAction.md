...
layout: docs
---
<span class="title">InAction</span><span class="type">class</span>
...
`DefineAction(In, TravelAction)      `*`// original source text`*  
`class `**`InAction`**` :   `[`TravelAction`](../object/TravelAction.html)`      `*`// after macro expansion`*
