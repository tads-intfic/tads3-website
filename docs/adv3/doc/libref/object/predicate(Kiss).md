...
layout: docs
---
<span class="title">predicate(Kiss)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Kiss)`</span>` :   `[`KissAction`](../object/KissAction.html)`      `*`// after macro expansion`*
