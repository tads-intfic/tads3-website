...
layout: docs
---
<span class="title">predicate(Close)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Close)`</span>` :   `[`CloseAction`](../object/CloseAction.html)*`// after macro expansion`*
