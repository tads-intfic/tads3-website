...
layout: docs
---
<span class="title">predicate(Hint)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Hint)`</span>` :   `[`HintAction`](../object/HintAction.html)*`// after macro expansion`*
