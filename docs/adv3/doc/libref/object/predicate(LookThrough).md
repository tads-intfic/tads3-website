...
layout: docs
---
<span class="title">predicate(LookThrough)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(LookThrough)`</span>` :   `[`LookThroughAction`](../object/LookThroughAction.html)`      `*`// after macro expansion`*
