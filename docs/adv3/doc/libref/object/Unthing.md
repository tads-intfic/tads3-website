...
layout: docs
---
<span class="title">Unthing</span><span class="type">class</span>
...
An unthing is essentially a decoration, but we use a customized message
that says "that isn't here" rather than "that isn't important".
...
[`dobjFor(Default)`](../object/Decoration.html#dobjFor(Default))[`dobjFor(Examine)`](../object/Decoration.html#dobjFor(Examine))[`dobjFor(ListenTo)`](../object/Decoration.html#dobjFor(ListenTo))[`dobjFor(LookIn)`](../object/Decoration.html#dobjFor(LookIn))[`dobjFor(Read)`](../object/Decoration.html#dobjFor(Read))[`dobjFor(Search)`](../object/Decoration.html#dobjFor(Search))[`dobjFor(Smell)`](../object/Decoration.html#dobjFor(Smell))[`hideFromAll`](../object/Decoration.html#hideFromAll)[`iobjFor(Default)`](../object/Decoration.html#iobjFor(Default))[`lookInDesc`](../object/Decoration.html#lookInDesc)
...
will probably always be overridden in practice, since the point of this
...
`basicExamine ( )`<span class="rem">OVERRIDDEN</span>
...
`basicExamineListen (explicit)`<span class="rem">OVERRIDDEN</span>
...
`basicExamineSmell (explicit)`<span class="rem">OVERRIDDEN</span>
...
`throwNoMatchForLocation (txt)`<span class="rem">OVERRIDDEN</span>
...
`throwNoMatchForPossessive (txt)`<span class="rem">OVERRIDDEN</span>
...
things like "Bob doesn't appear to have that" or "You don't see that in
the box," but these don't make sense for an Unthing - we're not actually
here, so we can't "appear" or "seem" to own or contain anything.
...
`throwNothingInLocation ( )`<span class="rem">OVERRIDDEN</span>
