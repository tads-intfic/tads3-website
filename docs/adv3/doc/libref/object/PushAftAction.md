...
`DefineAction(PushAft, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushAftAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)`      `*`// after macro expansion`*
