...
` `[`dobjFor(PutBehind)`](../object/Component.html#dobjFor(PutBehind))`  `[`dobjFor(PutIn)`](../object/Component.html#dobjFor(PutIn))`  `[`dobjFor(PutOn)`](../object/Component.html#dobjFor(PutOn))`  `[`dobjFor(PutUnder)`](../object/Component.html#dobjFor(PutUnder))`  `[`dobjFor(Take)`](../object/Component.html#dobjFor(Take))`  `[`dobjFor(TakeFrom)`](../object/Component.html#dobjFor(TakeFrom))`  `[`hideFromAll`](../object/Component.html#hideFromAll)`  `[`isComponentOf`](../object/Component.html#isComponentOf)`  `[`meetsObjHeld`](../object/Component.html#meetsObjHeld)`  `[`verifyMoveTo`](../object/Component.html#verifyMoveTo)`  `
...
order to use a door, since the door has to go somewhere, and it can't go
inside the container it controls (because if it were inside, it wouldn't
be accessible when the container is closed).

By default, we assume that our immediate location is a complex
container, and its subContainer is the actual container for which we're
