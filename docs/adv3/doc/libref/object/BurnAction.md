...
layout: docs
---
<span class="title">BurnAction</span><span class="type">class</span>
...
`DefineTAction(Burn)      `*`// original source text`*  
`class `**`BurnAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
