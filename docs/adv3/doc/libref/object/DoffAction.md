...
layout: docs
---
<span class="title">DoffAction</span><span class="type">class</span>
...
`DefineTAction(Doff)      `*`// original source text`*  
`class `**`DoffAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
