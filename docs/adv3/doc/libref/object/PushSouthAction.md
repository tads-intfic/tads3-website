...
layout: docs
---
<span class="title">PushSouthAction</span><span class="type">class</span>
...
`DefineAction(PushSouth, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushSouthAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)*`// after macro expansion`*
