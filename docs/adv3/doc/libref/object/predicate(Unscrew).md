...
layout: docs
---
<span class="title">predicate(Unscrew)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Unscrew)`</span>` :   `[`UnscrewAction`](../object/UnscrewAction.html)*`// after macro expansion`*
