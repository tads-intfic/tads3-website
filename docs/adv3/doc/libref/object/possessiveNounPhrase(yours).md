...
layout: docs
---
<span class="title">possessiveNounPhrase(yours)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`possessiveNounPhrase`](../object/possessiveNounPhrase.html)`(yours)`</span>` :   `[`YoursNounProd`](../object/YoursNounProd.html)
