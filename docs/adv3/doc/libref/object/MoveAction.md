...
layout: docs
---
<span class="title">MoveAction</span><span class="type">class</span>
...
`DefineTAction(Move)      `*`// original source text`*  
`class `**`MoveAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
