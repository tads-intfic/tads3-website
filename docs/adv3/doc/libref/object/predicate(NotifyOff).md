<span class="title">predicate(NotifyOff)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(NotifyOff)`</span>` :   `[`NotifyOffAction`](../object/NotifyOffAction.html)`      `*`// after macro expansion`*
...
Inherited from `NotifyOffAction` :  
