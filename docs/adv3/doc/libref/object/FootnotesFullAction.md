...
layout: docs
---
<span class="title">FootnotesFullAction</span><span class="type">class</span>
...
`DefineAction(FootnotesFull, FootnotesAction)      `*`// original source text`*  
`class `**`FootnotesFullAction`**` :   `[`FootnotesAction`](../object/FootnotesAction.html)`      `*`// after macro expansion`*
