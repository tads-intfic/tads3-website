...
layout: docs
---
<span class="title">StandOnAction</span><span class="type">class</span>
...
`DefineTAction(StandOn)      `*`// original source text`*  
`class `**`StandOnAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
