---
---
<span class="title">ScrewAction</span><span class="type">class</span>
...
`DefineTAction(Screw)      `*`// original source text`*  
`class `**`ScrewAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
