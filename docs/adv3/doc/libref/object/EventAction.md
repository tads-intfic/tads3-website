<span class="title">EventAction</span><span class="type">class</span>
...
`class `**`EventAction`**` :   `[`Action`](../object/Action.html)
...
event actions are internal system actions; they don't consume additional
turns themselves, since they run between player turns
