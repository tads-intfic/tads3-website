...
layout: docs
---
<span class="title">predicate(Inventory)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Inventory)`</span>` :   `[`InventoryAction`](../object/InventoryAction.html)`      `*`// after macro expansion`*
