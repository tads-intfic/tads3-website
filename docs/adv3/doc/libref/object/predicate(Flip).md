...
layout: docs
---
<span class="title">predicate(Flip)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Flip)`</span>` :   `[`FlipAction`](../object/FlipAction.html)`      `*`// after macro expansion`*
