...
layout: docs
---
<span class="title">predicate(Oops)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Oops)`</span>` :   `[`OopsAction`](../object/OopsAction.html)*`// after macro expansion`*
...
[`actionTime`](../object/OopsAction.html#actionTime)
