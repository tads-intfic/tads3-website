...
layout: docs
---
<span class="title">predicate(RestoreDefaults)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(RestoreDefaults)`</span>` :   `[`RestoreDefaultsAction`](../object/RestoreDefaultsAction.html)`      `*`// after macro expansion`*
...
Inherited from `RestoreDefaultsAction` :  
