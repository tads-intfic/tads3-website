...
layout: docs
---
<span class="title">LookThroughAction</span><span class="type">class</span>
...
`DefineTAction(LookThrough)      `*`// original source text`*  
`class `**`LookThroughAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
