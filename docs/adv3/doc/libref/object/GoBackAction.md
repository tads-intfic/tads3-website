...
layout: docs
---
<span class="title">GoBackAction</span><span class="type">class</span>
...
`DefineIAction(GoBack)      `*`// original source text`*  
`class `**`GoBackAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
