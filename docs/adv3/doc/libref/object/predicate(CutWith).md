...
layout: docs
---
<span class="title">predicate(CutWith)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(CutWith)`</span>` :   `[`CutWithAction`](../object/CutWithAction.html)`      `*`// after macro expansion`*
