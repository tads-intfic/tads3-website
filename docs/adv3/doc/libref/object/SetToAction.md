...
layout: docs
---
<span class="title">SetToAction</span><span class="type">class</span>
...
`DefineLiteralTAction(SetTo, IndirectObject)      `*`// original source text`*  
`class `**`SetToAction`**` :   `[`LiteralTAction`](../object/LiteralTAction.html)`      `*`// after macro expansion`*
