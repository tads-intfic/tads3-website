---
---
<span class="title">DetachFromAction</span><span class="type">class</span>
...
`DefineTIAction(DetachFrom)      `*`// original source text`*  
`class `**`DetachFromAction`**` :   `[`TIAction`](../object/TIAction.html)`      `*`// after macro expansion`*
