...
layout: docs
---
<span class="title">predicate(TypeLiteralOnWhat)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TypeLiteralOnWhat)`</span>` :   `[`TypeLiteralOnAction`](../object/TypeLiteralOnAction.html)*`// after macro expansion`*
