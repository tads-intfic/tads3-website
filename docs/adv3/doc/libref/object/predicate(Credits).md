---
---
<span class="title">predicate(Credits)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Credits)`</span>` :   `[`CreditsAction`](../object/CreditsAction.html)`      `*`// after macro expansion`*
...
Inherited from `CreditsAction` :  
` `[`execSystemAction`](../object/CreditsAction.html#execSystemAction)`  `
