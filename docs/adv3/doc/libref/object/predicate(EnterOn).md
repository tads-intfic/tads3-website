...
layout: docs
---
<span class="title">predicate(EnterOn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(EnterOn)`</span>` :   `[`EnterOnAction`](../object/EnterOnAction.html)*`// after macro expansion`*
