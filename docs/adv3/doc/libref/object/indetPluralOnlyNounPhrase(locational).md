...
`grammar `<span class="gramalt">[`indetPluralOnlyNounPhrase`](../object/indetPluralOnlyNounPhrase.html)`(locational)`</span>` :   `[`ContainerNounPhraseProd`](../object/ContainerNounPhraseProd.html)
