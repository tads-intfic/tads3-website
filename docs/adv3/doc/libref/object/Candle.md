...
layout: docs
---
<span class="title">Candle</span><span class="type">class</span>
...
Ordinary candles are usually fire sources as well, in that you can light
one candle with another once the first one is lit. To get this effect,
mix FireSource into the superclass list (but put it before Candle, since
FireSource is specifically designed as a mix-in class).
...
Inherited from `FueledLightSource` :  
` `[`brightnessOn`](../object/FueledLightSource.html#brightnessOn)`  `[`burnDaemonObj`](../object/FueledLightSource.html#burnDaemonObj)`  `[`fuelLevel`](../object/FueledLightSource.html#fuelLevel)`  `[`fuelSource`](../object/FueledLightSource.html#fuelSource)`  `[`isLit`](../object/FueledLightSource.html#isLit)`  `

Inherited from `LightSource` :  
` `[`adjective`](../object/LightSource.html#adjective)`  `[`allStates`](../object/LightSource.html#allStates)`  `[`brightnessOff`](../object/LightSource.html#brightnessOff)`  `[`distinguishers`](../object/LightSource.html#distinguishers)`  `[`getState`](../object/LightSource.html#getState)`  `[`nameLit`](../object/LightSource.html#nameLit)`  `[`pluralNameLit`](../object/LightSource.html#pluralNameLit)`  `[`theNameLit`](../object/LightSource.html#theNameLit)`  `
...
checks applied by its own iobjFor(BurnWith) handlers. This can be
overridden if we can only be lit with specific sources of fire; for
example, a furnace with a deeply-recessed burner could refuse to be lit
...
`dobjFor(BurnWith)`<span class="rem">OVERRIDDEN</span>
...
`sayBurnedOut ( )`<span class="rem">OVERRIDDEN</span>
