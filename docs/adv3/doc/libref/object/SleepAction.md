...
layout: docs
---
<span class="title">SleepAction</span><span class="type">class</span>
...
`DefineIAction(Sleep)      `*`// original source text`*  
`class `**`SleepAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
