...
layout: docs
---
<span class="title">ExamineAction</span><span class="type">class</span>
...
`DefineTAction(Examine)      `*`// original source text`*  
`class `**`ExamineAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
