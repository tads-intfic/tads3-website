...
layout: docs
---
<span class="title">predicate(DetachFrom)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(DetachFrom)`</span>` :   `[`DetachFromAction`](../object/DetachFromAction.html)*`// after macro expansion`*
