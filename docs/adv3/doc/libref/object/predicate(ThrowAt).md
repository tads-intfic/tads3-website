...
layout: docs
---
<span class="title">predicate(ThrowAt)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ThrowAt)`</span>` :   `[`ThrowAtAction`](../object/ThrowAtAction.html)*`// after macro expansion`*
