...
layout: docs
---
<span class="title">StretchyContainer</span><span class="type">class</span>
...
[`cannotMoveThroughMsg`](../object/BasicContainer.html#cannotMoveThroughMsg) [`cannotTouchThroughMsg`](../object/BasicContainer.html#cannotTouchThroughMsg) [`isOpen`](../object/BasicContainer.html#isOpen) [`material`](../object/BasicContainer.html#material) [`putDestMessage`](../object/BasicContainer.html#putDestMessage) [`tooLargeForContainerMsg`](../object/BasicContainer.html#tooLargeForContainerMsg)
...
Inherited from `Container` :  
[`dobjFor(LookIn)`](../object/Container.html#dobjFor(LookIn)) [`dobjFor(Search)`](../object/Container.html#dobjFor(Search)) [`examineContainerStatus`](../object/Container.html#examineContainerStatus) [`examineStatus`](../object/Container.html#examineStatus) [`iobjFor(PutIn)`](../object/Container.html#iobjFor(PutIn)) [`tryMovingObjInto`](../object/Container.html#tryMovingObjInto) [`tryPuttingObjInBag`](../object/Container.html#tryPuttingObjInBag)
...
`checkBulkChangeWithin (changingObj)`<span class="rem">OVERRIDDEN</span>
...
`checkBulkInserted (insertedObj)`<span class="rem">OVERRIDDEN</span>
...
so we can examine our current status to see if everything works.
...
`getBulk ( )`<span class="rem">OVERRIDDEN</span>
