...
layout: docs
---
<span class="title">predicate(UnfastenFrom)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(UnfastenFrom)`</span>` :   `[`UnfastenFromAction`](../object/UnfastenFromAction.html)`      `*`// after macro expansion`*
