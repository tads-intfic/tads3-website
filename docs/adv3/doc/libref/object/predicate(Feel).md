...
layout: docs
---
<span class="title">predicate(Feel)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Feel)`</span>` :   `[`FeelAction`](../object/FeelAction.html)*`// after macro expansion`*
