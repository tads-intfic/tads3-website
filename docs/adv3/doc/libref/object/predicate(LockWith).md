...
layout: docs
---
<span class="title">predicate(LockWith)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(LockWith)`</span>` :   `[`LockWithAction`](../object/LockWithAction.html)`      `*`// after macro expansion`*
