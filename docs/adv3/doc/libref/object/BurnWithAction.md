...
layout: docs
---
<span class="title">BurnWithAction</span><span class="type">class</span>
...
`DefineTIAction(BurnWith)      `*`// original source text`*  
`class `**`BurnWithAction`**` :   `[`TIAction`](../object/TIAction.html)*`// after macro expansion`*
