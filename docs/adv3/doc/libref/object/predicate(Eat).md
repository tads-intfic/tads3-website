...
layout: docs
---
<span class="title">predicate(Eat)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Eat)`</span>` :   `[`EatAction`](../object/EatAction.html)*`// after macro expansion`*
