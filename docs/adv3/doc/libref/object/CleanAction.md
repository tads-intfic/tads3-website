...
layout: docs
---
<span class="title">CleanAction</span><span class="type">class</span>
...
`DefineTAction(Clean)      `*`// original source text`*  
`class `**`CleanAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
