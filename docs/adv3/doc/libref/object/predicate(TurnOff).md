...
layout: docs
---
<span class="title">predicate(TurnOff)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TurnOff)`</span>` :   `[`TurnOffAction`](../object/TurnOffAction.html)`      `*`// after macro expansion`*
