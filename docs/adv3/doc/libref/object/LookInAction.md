...
layout: docs
---
<span class="title">LookInAction</span><span class="type">class</span>
...
`DefineTAction(LookIn)      `*`// original source text`*  
`class `**`LookInAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
