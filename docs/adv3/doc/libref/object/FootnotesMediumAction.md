...
layout: docs
---
<span class="title">FootnotesMediumAction</span><span class="type">class</span>
...
`DefineAction(FootnotesMedium, FootnotesAction)      `*`// original source text`*  
`class `**`FootnotesMediumAction`**` :   `[`FootnotesAction`](../object/FootnotesAction.html)*`// after macro expansion`*
...
`showFootnotes`<span class="rem">OVERRIDDEN</span>
