...
layout: docs
---
<span class="title">predicate(RecordEventsString)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(RecordEventsString)`</span>` :   `[`RecordEventsStringAction`](../object/RecordEventsStringAction.html)*`// after macro expansion`*
...
Inherited from `RecordEventsStringAction` :  
