---
---
<span class="title">SouthAction</span><span class="type">class</span>
...
`DefineAction(South, TravelAction)      `*`// original source text`*  
`class `**`SouthAction`**` :   `[`TravelAction`](../object/TravelAction.html)`      `*`// after macro expansion`*
