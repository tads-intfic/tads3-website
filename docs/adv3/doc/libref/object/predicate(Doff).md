...
layout: docs
---
<span class="title">predicate(Doff)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Doff)`</span>` :   `[`DoffAction`](../object/DoffAction.html)*`// after macro expansion`*
