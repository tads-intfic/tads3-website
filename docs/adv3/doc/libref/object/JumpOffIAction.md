...
layout: docs
---
<span class="title">JumpOffIAction</span><span class="type">class</span>
...
`DefineIAction(JumpOffI)      `*`// original source text`*  
`class `**`JumpOffIAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
