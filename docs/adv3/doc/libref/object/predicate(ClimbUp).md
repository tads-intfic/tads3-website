<span class="title">predicate(ClimbUp)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ClimbUp)`</span>` :   `[`ClimbUpAction`](../object/ClimbUpAction.html)`      `*`// after macro expansion`*
