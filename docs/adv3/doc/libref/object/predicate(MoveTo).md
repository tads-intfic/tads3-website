---
---
<span class="title">predicate(MoveTo)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(MoveTo)`</span>` :   `[`MoveToAction`](../object/MoveToAction.html)`      `*`// after macro expansion`*
