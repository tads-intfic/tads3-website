...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(FootnotesOff)`</span>` :   `[`FootnotesOffAction`](../object/FootnotesOffAction.html)`      `*`// after macro expansion`*
...
Inherited from `FootnotesOffAction` :  
