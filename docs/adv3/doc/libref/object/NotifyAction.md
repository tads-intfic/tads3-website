...
layout: docs
---
<span class="title">NotifyAction</span><span class="type">class</span>
...
`DefineSystemAction(Notify)      `*`// original source text`*  
`class `**`NotifyAction`**` :   `[`SystemAction`](../object/SystemAction.html)*`// after macro expansion`*
