...
layout: docs
---
<span class="title">predicate(Throw)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Throw)`</span>` :   `[`ThrowAction`](../object/ThrowAction.html)*`// after macro expansion`*
