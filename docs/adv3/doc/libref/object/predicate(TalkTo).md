---
---
<span class="title">predicate(TalkTo)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TalkTo)`</span>` :   `[`TalkToAction`](../object/TalkToAction.html)`      `*`// after macro expansion`*
