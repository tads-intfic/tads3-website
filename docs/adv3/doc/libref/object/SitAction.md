...
layout: docs
---
<span class="title">SitAction</span><span class="type">class</span>
...
`DefineIAction(Sit)      `*`// original source text`*  
`class `**`SitAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
