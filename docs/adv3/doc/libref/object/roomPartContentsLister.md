...
layout: docs
---
<span class="title">roomPartContentsLister</span><span class="type">object</span>
...
**`roomPartContentsLister`**` :   `[`surfaceContentsLister`](../object/surfaceContentsLister.html)
