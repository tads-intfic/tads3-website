...
layout: docs
---
<span class="title">CloseAction</span><span class="type">class</span>
...
`DefineTAction(Close)      `*`// original source text`*  
`class `**`CloseAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
