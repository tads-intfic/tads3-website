...
layout: docs
---
<span class="title">PushUpAction</span><span class="type">class</span>
...
`DefineAction(PushUp, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushUpAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)*`// after macro expansion`*
