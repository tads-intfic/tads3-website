---
---
<span class="title">predicate(LookIn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(LookIn)`</span>` :   `[`LookInAction`](../object/LookInAction.html)`      `*`// after macro expansion`*
