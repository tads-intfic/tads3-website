...
layout: docs
---
<span class="title">predicate(Wear)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Wear)`</span>` :   `[`WearAction`](../object/WearAction.html)*`// after macro expansion`*
