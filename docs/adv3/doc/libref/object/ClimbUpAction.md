---
---
<span class="title">ClimbUpAction</span><span class="type">class</span>
...
`DefineTAction(ClimbUp)      `*`// original source text`*  
`class `**`ClimbUpAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
