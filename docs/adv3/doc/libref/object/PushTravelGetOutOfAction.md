...
layout: docs
---
<span class="title">PushTravelGetOutOfAction</span><span class="type">class</span>
...
`DefineTIActionSub(PushTravelGetOutOf, PushTravelViaIobjAction)      `*`// original source text`*  
`class `**`PushTravelGetOutOfAction`**` :   `[`PushTravelViaIobjAction`](../object/PushTravelViaIobjAction.html)*`// after macro expansion`*
