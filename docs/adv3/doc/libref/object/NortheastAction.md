...
layout: docs
---
<span class="title">NortheastAction</span><span class="type">class</span>
...
`DefineAction(Northeast, TravelAction)      `*`// original source text`*  
`class `**`NortheastAction`**` :   `[`TravelAction`](../object/TravelAction.html)`      `*`// after macro expansion`*
