...
layout: docs
---
<span class="title">CreditsAction</span><span class="type">class</span>
...
`DefineSystemAction(Credits)      `*`// original source text`*  
`class `**`CreditsAction`**` :   `[`SystemAction`](../object/SystemAction.html)*`// after macro expansion`*
