...
layout: docs
---
<span class="title">Matchstick</span><span class="type">class</span>

[extras.t](../file/extras.t.html)\[[1944](../source/extras.t.html#1944)\],
[en_us.t](../file/en_us.t.html)\[[2914](../source/en_us.t.html#2914)\]
...
`brightnessOn`<span class="rem">OVERRIDDEN</span>
...
`isEquivalent`<span class="rem">OVERRIDDEN</span>
...
`dobjFor(Burn)`<span class="rem">OVERRIDDEN</span>
...
`dobjFor(Strike)`<span class="rem">OVERRIDDEN</span>
...
`iobjFor(BurnWith)`<span class="rem">OVERRIDDEN</span>
