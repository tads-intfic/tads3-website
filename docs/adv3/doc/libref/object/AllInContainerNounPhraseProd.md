...
layout: docs
---
<span class="title">AllInContainerNounPhraseProd</span><span class="type">class</span>
...
`class `**`AllInContainerNounPhraseProd`**` :   `[`VagueContainerNounPhraseProd`](../object/VagueContainerNounPhraseProd.html)
