...
layout: docs
---
<span class="title">predicate(Port)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Port)`</span>` :   `[`PortAction`](../object/PortAction.html)*`// after macro expansion`*
...
[`getDirection`](../object/PortAction.html#getDirection)
