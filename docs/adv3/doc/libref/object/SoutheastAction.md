...
layout: docs
---
<span class="title">SoutheastAction</span><span class="type">class</span>
...
`DefineAction(Southeast, TravelAction)      `*`// original source text`*  
`class `**`SoutheastAction`**` :   `[`TravelAction`](../object/TravelAction.html)*`// after macro expansion`*
