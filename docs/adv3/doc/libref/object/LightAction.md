...
layout: docs
---
<span class="title">LightAction</span><span class="type">class</span>
...
`DefineTAction(Light)      `*`// original source text`*  
`class `**`LightAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
