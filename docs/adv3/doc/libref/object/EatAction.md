...
layout: docs
---
<span class="title">EatAction</span><span class="type">class</span>
...
`DefineTAction(Eat)      `*`// original source text`*  
`class `**`EatAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
