---
---
<span class="title">PushTravelEnterAction</span><span class="type">class</span>
...
`DefineTIActionSub(PushTravelEnter, PushTravelViaIobjAction)      `*`// original source text`*  
`class `**`PushTravelEnterAction`**` :   `[`PushTravelViaIobjAction`](../object/PushTravelViaIobjAction.html)`      `*`// after macro expansion`*
