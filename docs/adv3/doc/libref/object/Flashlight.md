...
flashlight can be on without providing light, when the battery is dead.
For this reason, you might want to override the decription, and possibly
the TurnOn action() handler, to customize the messages for the case when
the flashlight is switched on but out of power.
...
[`adjective`](../object/LightSource.html#adjective)[`allStates`](../object/LightSource.html#allStates)[`brightnessOff`](../object/LightSource.html#brightnessOff)[`brightnessOn`](../object/LightSource.html#brightnessOn)[`distinguishers`](../object/LightSource.html#distinguishers)[`getState`](../object/LightSource.html#getState)[`isLit`](../object/LightSource.html#isLit)[`nameLit`](../object/LightSource.html#nameLit)[`pluralNameLit`](../object/LightSource.html#pluralNameLit)[`theNameLit`](../object/LightSource.html#theNameLit)
...
`dobjFor(Extinguish)`<span class="rem">OVERRIDDEN</span>
...
`dobjFor(Light)`<span class="rem">OVERRIDDEN</span>
...
`dobjFor(TurnOn)`<span class="rem">OVERRIDDEN</span>
...
`makeOn (stat)`<span class="rem">OVERRIDDEN</span>
...
LightSource should never be called directly on a Flashlight object,
