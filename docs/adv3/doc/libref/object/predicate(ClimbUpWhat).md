...
layout: docs
---
<span class="title">predicate(ClimbUpWhat)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ClimbUpWhat)`</span>` :   `[`ClimbUpAction`](../object/ClimbUpAction.html)*`// after macro expansion`*
