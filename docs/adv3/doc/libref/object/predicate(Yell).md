...
layout: docs
---
<span class="title">predicate(Yell)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Yell)`</span>` :   `[`YellAction`](../object/YellAction.html)*`// after macro expansion`*
...
Inherited from `YellAction` :  
[`execAction`](../object/YellAction.html#execAction)
