...
layout: docs
---
<span class="title">UnfastenFromAction</span><span class="type">class</span>
...
`DefineTIAction(UnfastenFrom)      `*`// original source text`*  
`class `**`UnfastenFromAction`**` :   `[`TIAction`](../object/TIAction.html)*`// after macro expansion`*
