...
`grammar `<span class="gramalt">[`possessiveNounPhrase`](../object/possessiveNounPhrase.html)`(theirs)`</span>` :   `[`TheirsNounProd`](../object/TheirsNounProd.html)
