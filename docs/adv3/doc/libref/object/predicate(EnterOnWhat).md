...
layout: docs
---
<span class="title">predicate(EnterOnWhat)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(EnterOnWhat)`</span>` :   `[`EnterOnAction`](../object/EnterOnAction.html)`      `*`// after macro expansion`*
