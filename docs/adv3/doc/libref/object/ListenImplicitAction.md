...
layout: docs
---
<span class="title">ListenImplicitAction</span><span class="type">class</span>
...
`DefineAction(ListenImplicit, SenseImplicitAction)      `*`// original source text`*  
`class `**`ListenImplicitAction`**` :   `[`SenseImplicitAction`](../object/SenseImplicitAction.html)*`// after macro expansion`*
...
`defaultMsgProp`<span class="rem">OVERRIDDEN</span>
...
`descProp`<span class="rem">OVERRIDDEN</span>
...
`mySense`<span class="rem">OVERRIDDEN</span>
...
`resultLister`<span class="rem">OVERRIDDEN</span>
