---
---
<span class="title">predicate(StandOn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(StandOn)`</span>` :   `[`StandOnAction`](../object/StandOnAction.html)`      `*`// after macro expansion`*
