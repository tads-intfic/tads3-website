...
layout: docs
---
<span class="title">predicate(Yes)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Yes)`</span>` :   `[`YesAction`](../object/YesAction.html)*`// after macro expansion`*
...
Inherited from `YesAction` :  
[`execAction`](../object/YesAction.html#execAction)
