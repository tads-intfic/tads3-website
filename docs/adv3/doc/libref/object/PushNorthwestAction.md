...
layout: docs
---
<span class="title">PushNorthwestAction</span><span class="type">class</span>
...
`DefineAction(PushNorthwest, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushNorthwestAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)*`// after macro expansion`*
