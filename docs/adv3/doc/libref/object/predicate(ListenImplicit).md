<span class="title">predicate(ListenImplicit)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ListenImplicit)`</span>` :   `[`ListenImplicitAction`](../object/ListenImplicitAction.html)`      `*`// after macro expansion`*
...
Inherited from `ListenImplicitAction` :  
` `[`defaultMsgProp`](../object/ListenImplicitAction.html#defaultMsgProp)`  `[`descProp`](../object/ListenImplicitAction.html#descProp)`  `[`mySense`](../object/ListenImplicitAction.html#mySense)`  `[`resultLister`](../object/ListenImplicitAction.html#resultLister)`  `
...
Inherited from `SenseImplicitAction` :  
