...
layout: docs
---
<span class="title">ForeAction</span><span class="type">class</span>
...
`DefineAction(Fore, TravelAction)      `*`// original source text`*  
`class `**`ForeAction`**` :   `[`TravelAction`](../object/TravelAction.html)`      `*`// after macro expansion`*
