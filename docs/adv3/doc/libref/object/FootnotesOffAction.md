---
---
<span class="title">FootnotesOffAction</span><span class="type">class</span>
...
`DefineAction(FootnotesOff, FootnotesAction)      `*`// original source text`*  
`class `**`FootnotesOffAction`**` :   `[`FootnotesAction`](../object/FootnotesAction.html)`      `*`// after macro expansion`*
