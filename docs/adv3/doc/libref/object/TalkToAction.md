...
layout: docs
---
<span class="title">TalkToAction</span><span class="type">class</span>
...
`DefineTAction(TalkTo)      `*`// original source text`*  
`class `**`TalkToAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
