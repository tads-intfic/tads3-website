...
[en_us.t](../file/en_us.t.html)\[[2903](../source/en_us.t.html#2903)\]
...
actually have to be closable.

Examples of booths: a cardboard box large enough for an actor can stand
in; a closet; a shallow pit.
...
Inherited from `Container` :  
[`examineContainerStatus`](../object/Container.html#examineContainerStatus)[`tryPuttingObjInBag`](../object/Container.html#tryPuttingObjInBag)

Inherited from `BasicContainer` :  
[`canFitObjThruOpening`](../object/BasicContainer.html#canFitObjThruOpening)[`canObjReachThruOpening`](../object/BasicContainer.html#canObjReachThruOpening)
...
`mapPushTravelIobj (PushTravelEnter, Board)`<span class="rem">OVERRIDDEN</span>
...
`tryMovingIntoNested ( )`<span class="rem">OVERRIDDEN</span>
