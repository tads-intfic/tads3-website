...
layout: docs
---
<span class="title">predicate(HintsOff)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(HintsOff)`</span>` :   `[`HintsOffAction`](../object/HintsOffAction.html)*`// after macro expansion`*
