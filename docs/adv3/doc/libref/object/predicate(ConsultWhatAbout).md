---
---
<span class="title">predicate(ConsultWhatAbout)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ConsultWhatAbout)`</span>` :   `[`ConsultAboutAction`](../object/ConsultAboutAction.html)`      `*`// after macro expansion`*
...
`whichMessageTopic`<span class="rem">OVERRIDDEN</span>
