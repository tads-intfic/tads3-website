...
layout: docs
---
<span class="title">PushNortheastAction</span><span class="type">class</span>
...
`DefineAction(PushNortheast, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushNortheastAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)*`// after macro expansion`*
