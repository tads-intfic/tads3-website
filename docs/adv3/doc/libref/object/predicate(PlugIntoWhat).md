...
layout: docs
---
<span class="title">predicate(PlugIntoWhat)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PlugIntoWhat)`</span>` :   `[`PlugIntoAction`](../object/PlugIntoAction.html)*`// after macro expansion`*
