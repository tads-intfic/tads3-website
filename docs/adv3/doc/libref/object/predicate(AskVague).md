<span class="title">predicate(AskVague)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(AskVague)`</span>` :   `[`AskVagueAction`](../object/AskVagueAction.html)`      `*`// after macro expansion`*
