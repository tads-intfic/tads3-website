...
layout: docs
---
<span class="title">DefaultDescCommandReport</span><span class="type">class</span>
...
`class `**`DefaultDescCommandReport`**` :   `[`CommandReportMessage`](../object/CommandReportMessage.html)
