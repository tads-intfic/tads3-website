...
layout: docs
---
<span class="title">CutAction</span><span class="type">class</span>
...
`DefineTAction(Cut)      `*`// original source text`*  
`class `**`CutAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
