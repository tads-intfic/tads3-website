...
layout: docs
---
<span class="title">PlugInAction</span><span class="type">class</span>
...
`DefineTAction(PlugIn)      `*`// original source text`*  
`class `**`PlugInAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
