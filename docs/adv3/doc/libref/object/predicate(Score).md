...
layout: docs
---
<span class="title">predicate(Score)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Score)`</span>` :   `[`ScoreAction`](../object/ScoreAction.html)*`// after macro expansion`*
...
[`includeInUndo`](../object/ScoreAction.html#includeInUndo) [`mentionedFullScore`](../object/ScoreAction.html#mentionedFullScore)
