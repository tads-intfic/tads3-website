...
layout: docs
---
<span class="title">NorthAction</span><span class="type">class</span>
...
`DefineAction(North, TravelAction)      `*`// original source text`*  
`class `**`NorthAction`**` :   `[`TravelAction`](../object/TravelAction.html)*`// after macro expansion`*
