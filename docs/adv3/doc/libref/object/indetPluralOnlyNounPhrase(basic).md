...
layout: docs
---
<span class="title">indetPluralOnlyNounPhrase(basic)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`indetPluralOnlyNounPhrase`](../object/indetPluralOnlyNounPhrase.html)`(basic)`</span>` :   `[`LayeredNounPhraseProd`](../object/LayeredNounPhraseProd.html)
