...
layout: docs
---
<span class="title">predicate(Notify)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Notify)`</span>` :   `[`NotifyAction`](../object/NotifyAction.html)*`// after macro expansion`*
