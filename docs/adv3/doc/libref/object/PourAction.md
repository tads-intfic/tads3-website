...
layout: docs
---
<span class="title">PourAction</span><span class="type">class</span>
...
`DefineTAction(Pour)      `*`// original source text`*  
`class `**`PourAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
