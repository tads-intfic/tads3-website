...
layout: docs
---
<span class="title">predicate(Attack)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Attack)`</span>` :   `[`AttackAction`](../object/AttackAction.html)*`// after macro expansion`*
