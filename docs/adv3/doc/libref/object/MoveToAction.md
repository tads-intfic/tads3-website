<span class="title">MoveToAction</span><span class="type">class</span>
...
`DefineTIAction(MoveTo)      `*`// original source text`*  
`class `**`MoveToAction`**` :   `[`TIAction`](../object/TIAction.html)`      `*`// after macro expansion`*
