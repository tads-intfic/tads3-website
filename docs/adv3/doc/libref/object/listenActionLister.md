...
layout: docs
---
<span class="title">listenActionLister</span><span class="type">object</span>
...
**`listenActionLister`**` :   `[`roomListenLister`](../object/roomListenLister.html)
...
**`listenActionLister`**  
[`roomListenLister`](../object/roomListenLister.html)  
...
Inherited from `roomListenLister` :  
