...
layout: docs
---
<span class="title">nounList(list)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`nounList`](../object/nounList.html)`(list)`</span>` :   `[`NounListProd`](../object/NounListProd.html)
