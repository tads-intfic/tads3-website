...
layout: docs
---
<span class="title">predicate(Switch)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Switch)`</span>` :   `[`SwitchAction`](../object/SwitchAction.html)`      `*`// after macro expansion`*
