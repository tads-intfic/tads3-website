...
layout: docs
---
<span class="title">AskForTopic</span><span class="type">class</span>
...
An ASK FOR topic database entry. This type of topic entry is included in
the ASK FOR list only.

`class `**`AskForTopic`**` :   `[`AskTellTopic`](../object/AskTellTopic.html)
