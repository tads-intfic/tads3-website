...
layout: docs
---
<span class="title">UnscrewAction</span><span class="type">class</span>
...
`DefineTAction(Unscrew)      `*`// original source text`*  
`class `**`UnscrewAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
