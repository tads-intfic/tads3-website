...
`class `**`StairwayUp`**` :   `[`Stairway`](../object/Stairway.html)
...
Inherited from `Stairway` :  
[`dobjFor(Climb)`](../object/Stairway.html#dobjFor(Climb))
...
describe the actor arriving by coming down these stairs (they leave up,
so they arrive down)
