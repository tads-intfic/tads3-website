...
layout: docs
---
<span class="title">predicate(TakeFrom)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TakeFrom)`</span>` :   `[`TakeFromAction`](../object/TakeFromAction.html)*`// after macro expansion`*
...
Inherited from `TakeFromAction` :  
[`getAllDobj`](../object/TakeFromAction.html#getAllDobj)
