...
layout: docs
---
<span class="title">HintAction</span><span class="type">class</span>
...
`DefineSystemAction(Hint)      `*`// original source text`*  
`class `**`HintAction`**` :   `[`SystemAction`](../object/SystemAction.html)*`// after macro expansion`*
