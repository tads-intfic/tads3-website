...
layout: docs
---
<span class="title">TasteAction</span><span class="type">class</span>
...
`DefineTAction(Taste)      `*`// original source text`*  
`class `**`TasteAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
