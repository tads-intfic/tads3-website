...
layout: docs
---
<span class="title">ExtinguishAction</span><span class="type">class</span>
...
`DefineTAction(Extinguish)      `*`// original source text`*  
`class `**`ExtinguishAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
