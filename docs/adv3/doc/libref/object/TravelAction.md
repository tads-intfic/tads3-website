...
Each grammar rule for this action must set the 'dirMatch' property to a
DirectionProd match object that gives the direction.
...
`actionOfKind (cls)`<span class="rem">OVERRIDDEN</span>
