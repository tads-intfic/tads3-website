<span class="title">FastenAction</span><span class="type">class</span>
...
`DefineTAction(Fasten)      `*`// original source text`*  
`class `**`FastenAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
