...
layout: docs
---
<span class="title">DropAction</span><span class="type">class</span>
...
`DefineTAction(Drop)      `*`// original source text`*  
`class `**`DropAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
