...
layout: docs
---
<span class="title">predicate(Exits)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Exits)`</span>` :   `[`ExitsAction`](../object/ExitsAction.html)*`// after macro expansion`*
...
Inherited from `ExitsAction` :  
[`execAction`](../object/ExitsAction.html#execAction)
