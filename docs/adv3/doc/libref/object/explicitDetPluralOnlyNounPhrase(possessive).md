...
layout: docs
---
<span class="title">explicitDetPluralOnlyNounPhrase(possessive)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`explicitDetPluralOnlyNounPhrase`](../object/explicitDetPluralOnlyNounPhrase.html)`(possessive)`</span>` :   `[`PossessivePluralProd`](../object/PossessivePluralProd.html)
