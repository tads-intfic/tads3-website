---
---
<span class="title">FlipAction</span><span class="type">class</span>
...
`DefineTAction(Flip)      `*`// original source text`*  
`class `**`FlipAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
