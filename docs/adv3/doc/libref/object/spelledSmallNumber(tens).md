---
---
<span class="title">spelledSmallNumber(tens)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`spelledSmallNumber`](../object/spelledSmallNumber.html)`(tens)`</span>` :   `[`NumberProd`](../object/NumberProd.html)
