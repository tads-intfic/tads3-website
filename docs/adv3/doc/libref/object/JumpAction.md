---
---
<span class="title">JumpAction</span><span class="type">class</span>
...
`DefineIAction(Jump)      `*`// original source text`*  
`class `**`JumpAction`**` :   `[`IAction`](../object/IAction.html)`      `*`// after macro expansion`*
...
`preCond`<span class="rem">OVERRIDDEN</span>
