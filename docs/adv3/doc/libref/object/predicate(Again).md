...
layout: docs
---
<span class="title">predicate(Again)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Again)`</span>` :   `[`AgainAction`](../object/AgainAction.html)`      `*`// after macro expansion`*
...
` `[`actionTime`](../object/AgainAction.html#actionTime)`  `[`includeInUndo`](../object/AgainAction.html#includeInUndo)`  `[`isRepeatable`](../object/AgainAction.html#isRepeatable)`  `[`lastAction`](../object/AgainAction.html#lastAction)`  `[`lastIssuingActor`](../object/AgainAction.html#lastIssuingActor)`  `[`lastTargetActor`](../object/AgainAction.html#lastTargetActor)`  `[`lastTargetActorPhrase`](../object/AgainAction.html#lastTargetActorPhrase)`  `
