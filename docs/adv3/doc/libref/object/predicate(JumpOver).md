...
layout: docs
---
<span class="title">predicate(JumpOver)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(JumpOver)`</span>` :   `[`JumpOverAction`](../object/JumpOverAction.html)*`// after macro expansion`*
