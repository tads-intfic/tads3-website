...
layout: docs
---
<span class="title">PutUnderAction</span><span class="type">class</span>
...
`DefineTIAction(PutUnder)      `*`// original source text`*  
`class `**`PutUnderAction`**` :   `[`TIAction`](../object/TIAction.html)*`// after macro expansion`*
