...
layout: docs
---
<span class="title">AftAction</span><span class="type">class</span>
...
`DefineAction(Aft, TravelAction)      `*`// original source text`*  
`class `**`AftAction`**` :   `[`TravelAction`](../object/TravelAction.html)*`// after macro expansion`*
