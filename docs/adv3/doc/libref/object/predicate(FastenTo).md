...
layout: docs
---
<span class="title">predicate(FastenTo)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(FastenTo)`</span>` :   `[`FastenToAction`](../object/FastenToAction.html)*`// after macro expansion`*
