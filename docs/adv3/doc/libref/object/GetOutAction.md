...
layout: docs
---
<span class="title">GetOutAction</span><span class="type">class</span>
...
`DefineIAction(GetOut)      `*`// original source text`*  
`class `**`GetOutAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
