...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(InventoryTall)`</span>` :   `[`InventoryTallAction`](../object/InventoryTallAction.html)*`// after macro expansion`*
...
Inherited from `InventoryTallAction` :  
