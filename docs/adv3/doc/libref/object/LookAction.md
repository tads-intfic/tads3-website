...
layout: docs
---
<span class="title">LookAction</span><span class="type">class</span>
...
`DefineIAction(Look)      `*`// original source text`*  
`class `**`LookAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
