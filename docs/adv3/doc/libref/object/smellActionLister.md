...
layout: docs
---
<span class="title">smellActionLister</span><span class="type">object</span>
...
**`smellActionLister`**` :   `[`roomSmellLister`](../object/roomSmellLister.html)
...
**`smellActionLister`**  
[`roomSmellLister`](../object/roomSmellLister.html)  
...
[`isListed`](#isListed)[`showListEmpty`](#showListEmpty)

Inherited from `roomSmellLister` :  
