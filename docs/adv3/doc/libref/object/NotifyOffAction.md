...
layout: docs
---
<span class="title">NotifyOffAction</span><span class="type">class</span>
...
`DefineSystemAction(NotifyOff)      `*`// original source text`*  
`class `**`NotifyOffAction`**` :   `[`SystemAction`](../object/SystemAction.html)*`// after macro expansion`*
