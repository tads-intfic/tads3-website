...
layout: docs
---
<span class="title">predicate(RecordEvents)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(RecordEvents)`</span>` :   `[`RecordEventsAction`](../object/RecordEventsAction.html)*`// after macro expansion`*
...
Inherited from `RecordEventsAction` :  
