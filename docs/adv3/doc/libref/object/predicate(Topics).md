...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Topics)`</span>` :   `[`TopicsAction`](../object/TopicsAction.html)`      `*`// after macro expansion`*
