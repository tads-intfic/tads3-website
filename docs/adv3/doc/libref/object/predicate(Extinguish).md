...
layout: docs
---
<span class="title">predicate(Extinguish)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Extinguish)`</span>` :   `[`ExtinguishAction`](../object/ExtinguishAction.html)*`// after macro expansion`*
