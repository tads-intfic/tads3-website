...
layout: docs
---
<span class="title">DetachAction</span><span class="type">class</span>
...
`DefineTAction(Detach)      `*`// original source text`*  
`class `**`DetachAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
