...
layout: docs
---
<span class="title">ReadAction</span><span class="type">class</span>
...
`DefineTAction(Read)      `*`// original source text`*  
`class `**`ReadAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
