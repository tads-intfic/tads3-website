...
layout: docs
---
<span class="title">completeNounPhraseWithoutAll(her)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`completeNounPhraseWithoutAll`](../object/completeNounPhraseWithoutAll.html)`(her)`</span>` :   `[`HerProd`](../object/HerProd.html)
...
Inherited from `HerProd` :  
[`pronounType`](../object/HerProd.html#pronounType)
