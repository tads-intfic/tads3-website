...
layout: docs
---
<span class="title">ClimbAction</span><span class="type">class</span>
...
`DefineTAction(Climb)      `*`// original source text`*  
`class `**`ClimbAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
