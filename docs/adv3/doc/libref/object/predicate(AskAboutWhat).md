...
layout: docs
---
<span class="title">predicate(AskAboutWhat)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(AskAboutWhat)`</span>` :   `[`AskAboutAction`](../object/AskAboutAction.html)*`// after macro expansion`*
