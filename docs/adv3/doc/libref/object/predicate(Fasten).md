...
layout: docs
---
<span class="title">predicate(Fasten)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Fasten)`</span>` :   `[`FastenAction`](../object/FastenAction.html)*`// after macro expansion`*
