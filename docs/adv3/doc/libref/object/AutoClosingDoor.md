...
layout: docs
---
<span class="title">AutoClosingDoor</span><span class="type">class</span>
...
Inherited from `Door` :  
[`cannotTravel`](../object/Door.html#cannotTravel) [`connectorTravelPreCond`](../object/Door.html#connectorTravelPreCond) [`dobjFor(Close)`](../object/Door.html#dobjFor(Close)) [`dobjFor(Lock)`](../object/Door.html#dobjFor(Lock)) [`dobjFor(LookBehind)`](../object/Door.html#dobjFor(LookBehind)) [`dobjFor(LookThrough)`](../object/Door.html#dobjFor(LookThrough)) [`getDoorOpenPreCond`](../object/Door.html#getDoorOpenPreCond)

Inherited from `Openable` :  
[`addInteriorReachableCond`](../object/Openable.html#addInteriorReachableCond) [`dobjFor(Board)`](../object/Openable.html#dobjFor(Board)) [`dobjFor(GetOutOf)`](../object/Openable.html#dobjFor(GetOutOf)) [`dobjFor(LockWith)`](../object/Openable.html#dobjFor(LockWith)) [`dobjFor(LookIn)`](../object/Openable.html#dobjFor(LookIn)) [`dobjFor(Open)`](../object/Openable.html#dobjFor(Open)) [`dobjFor(Search)`](../object/Openable.html#dobjFor(Search)) [`iobjFor(PourInto)`](../object/Openable.html#iobjFor(PourInto)) [`iobjFor(PutIn)`](../object/Openable.html#iobjFor(PutIn)) [`openStatus`](../object/Openable.html#openStatus)
...
Inherited from `Passage` :  
[`canActorTravel`](../object/Passage.html#canActorTravel) [`connectorBack`](../object/Passage.html#connectorBack) [`fixedSource`](../object/Passage.html#fixedSource) [`getDestination`](../object/Passage.html#getDestination) [`getFacets`](../object/Passage.html#getFacets) [`initMasterObject`](../object/Passage.html#initMasterObject) [`isConnectorPassable`](../object/Passage.html#isConnectorPassable) [`isConnectorVisibleInDark`](../object/Passage.html#isConnectorVisibleInDark)
