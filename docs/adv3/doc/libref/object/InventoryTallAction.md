---
---
<span class="title">InventoryTallAction</span><span class="type">class</span>
...
`DefineIAction(InventoryTall)      `*`// original source text`*  
`class `**`InventoryTallAction`**` :   `[`IAction`](../object/IAction.html)`      `*`// after macro expansion`*
