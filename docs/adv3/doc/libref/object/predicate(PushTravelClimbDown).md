...
layout: docs
---
<span class="title">predicate(PushTravelClimbDown)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PushTravelClimbDown)`</span>` :   `[`PushTravelClimbDownAction`](../object/PushTravelClimbDownAction.html)*`// after macro expansion`*
...
Inherited from `PushTravelClimbDownAction` :  
