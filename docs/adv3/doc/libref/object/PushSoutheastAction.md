...
layout: docs
---
<span class="title">PushSoutheastAction</span><span class="type">class</span>
...
`DefineAction(PushSoutheast, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushSoutheastAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)*`// after macro expansion`*
