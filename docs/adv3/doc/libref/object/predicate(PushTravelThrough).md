...
layout: docs
---
<span class="title">predicate(PushTravelThrough)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PushTravelThrough)`</span>` :   `[`PushTravelThroughAction`](../object/PushTravelThroughAction.html)*`// after macro expansion`*
...
Inherited from `PushTravelThroughAction` :  
