...
layout: docs
---
<span class="title">predicate(Set)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Set)`</span>` :   `[`SetAction`](../object/SetAction.html)*`// after macro expansion`*
