...
layout: docs
---
<span class="title">predicate(FootnotesFull)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(FootnotesFull)`</span>` :   `[`FootnotesFullAction`](../object/FootnotesFullAction.html)*`// after macro expansion`*
...
Inherited from `FootnotesFullAction` :  
