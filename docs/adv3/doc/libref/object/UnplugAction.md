...
layout: docs
---
<span class="title">UnplugAction</span><span class="type">class</span>
...
`DefineTAction(Unplug)      `*`// original source text`*  
`class `**`UnplugAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
