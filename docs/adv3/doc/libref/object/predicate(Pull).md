...
layout: docs
---
<span class="title">predicate(Pull)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Pull)`</span>` :   `[`PullAction`](../object/PullAction.html)*`// after macro expansion`*
