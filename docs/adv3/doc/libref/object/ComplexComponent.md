...
layout: docs
---
<span class="title">ComplexComponent</span><span class="type">class</span>
...
container sub-objects because it makes them inseparable from the complex
container. It's also based on NameAsParent, which makes the object
automatically use the same name (in messages) as the lexical parent
object. This is usually what one wants for a sub-object of a complex
container, because it makes the sub-object essentially invisible to the
user by referring to the sub-object in messages as though it were the
complex container itself: "The washing machine contains...".
...
dynamically created at run-time (using 'new') must have their locations
set manually, because initializeLocation() won't be called automatically
in those cases.
...
Inherited from `NameAsParent` :  
[`targetObj`](../object/NameAsParent.html#targetObj)

Inherited from `NameAsOther` :  
[`aNameObj`](../object/NameAsOther.html#aNameObj)[`isIt`](../object/NameAsOther.html#isIt)[`itIs`](../object/NameAsOther.html#itIs)[`itIsContraction`](../object/NameAsOther.html#itIsContraction)[`itNom`](../object/NameAsOther.html#itNom)[`itObj`](../object/NameAsOther.html#itObj)[`itPossAdj`](../object/NameAsOther.html#itPossAdj)[`itPossNoun`](../object/NameAsOther.html#itPossNoun)[`itReflexive`](../object/NameAsOther.html#itReflexive)[`nameIs`](../object/NameAsOther.html#nameIs)[`nameIsnt`](../object/NameAsOther.html#nameIsnt)[`thatIsContraction`](../object/NameAsOther.html#thatIsContraction)[`thatNom`](../object/NameAsOther.html#thatNom)[`thatObj`](../object/NameAsOther.html#thatObj)[`theNameObj`](../object/NameAsOther.html#theNameObj)[`theNamePossAdj`](../object/NameAsOther.html#theNamePossAdj)[`theNameWithOwner`](../object/NameAsOther.html#theNameWithOwner)[`verbEndingEs`](../object/NameAsOther.html#verbEndingEs)[`verbEndingIes`](../object/NameAsOther.html#verbEndingIes)[`verbEndingS`](../object/NameAsOther.html#verbEndingS)[`verbToBe`](../object/NameAsOther.html#verbToBe)[`verbToHave`](../object/NameAsOther.html#verbToHave)[`verbWas`](../object/NameAsOther.html#verbWas)
...
[`dobjFor(PutBehind)`](../object/Component.html#dobjFor(PutBehind))[`dobjFor(PutIn)`](../object/Component.html#dobjFor(PutIn))[`dobjFor(PutOn)`](../object/Component.html#dobjFor(PutOn))[`dobjFor(PutUnder)`](../object/Component.html#dobjFor(PutUnder))[`dobjFor(Take)`](../object/Component.html#dobjFor(Take))[`dobjFor(TakeFrom)`](../object/Component.html#dobjFor(TakeFrom))[`isComponentOf`](../object/Component.html#isComponentOf)[`meetsObjHeld`](../object/Component.html#meetsObjHeld)[`verifyMoveTo`](../object/Component.html#verifyMoveTo)
...
the staging location. Normally our staging location would be our direct
container, but as with other aspects of complex containers, the
container/component are meant to act as a single combined object, so
...
`getIdentityObject ( )`<span class="rem">OVERRIDDEN</span>
...
`initializeLocation ( )`<span class="rem">OVERRIDDEN</span>
