<span class="title">predicate(Taste)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Taste)`</span>` :   `[`TasteAction`](../object/TasteAction.html)`      `*`// after macro expansion`*
