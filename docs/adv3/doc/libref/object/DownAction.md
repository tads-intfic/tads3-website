...
layout: docs
---
<span class="title">DownAction</span><span class="type">class</span>
...
`DefineAction(Down, TravelAction)      `*`// original source text`*  
`class `**`DownAction`**` :   `[`TravelAction`](../object/TravelAction.html)*`// after macro expansion`*
