...
layout: docs
---
<span class="title">predicate(OopsOnly)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(OopsOnly)`</span>` :   `[`OopsIAction`](../object/OopsIAction.html)*`// after macro expansion`*
...
Inherited from `OopsIAction` :  
[`actionTime`](../object/OopsIAction.html#actionTime)
...
Inherited from `OopsIAction` :  
[`doActionMain`](../object/OopsIAction.html#doActionMain)
