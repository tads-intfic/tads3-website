...
layout: docs
---
<span class="title">completeNounPhraseWithoutAll(yourself)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`completeNounPhraseWithoutAll`](../object/completeNounPhraseWithoutAll.html)`(yourself)`</span>` :   `[`YouProd`](../object/YouProd.html)
