...
layout: docs
---
<span class="title">nounWord(noun)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`nounWord`](../object/nounWord.html)`(noun)`</span>` :   `[`NounWordProd`](../object/NounWordProd.html)
...
[`getAdjustedTokens`](../object/NounWordProd.html#getAdjustedTokens) [`getNounText`](../object/NounWordProd.html#getNounText) [`getVocabMatchList`](../object/NounWordProd.html#getVocabMatchList)
