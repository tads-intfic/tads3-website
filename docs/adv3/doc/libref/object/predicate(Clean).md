...
layout: docs
---
<span class="title">predicate(Clean)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Clean)`</span>` :   `[`CleanAction`](../object/CleanAction.html)`      `*`// after macro expansion`*
