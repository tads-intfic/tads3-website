...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Jump)`</span>` :   `[`JumpAction`](../object/JumpAction.html)`      `*`// after macro expansion`*
...
Inherited from `JumpAction` :  
` `[`preCond`](../object/JumpAction.html#preCond)`  `
...
Inherited from `JumpAction` :  
` `[`execAction`](../object/JumpAction.html#execAction)`  `
