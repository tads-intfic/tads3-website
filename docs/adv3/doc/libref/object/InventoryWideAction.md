...
layout: docs
---
<span class="title">InventoryWideAction</span><span class="type">class</span>
...
`DefineIAction(InventoryWide)      `*`// original source text`*  
`class `**`InventoryWideAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
