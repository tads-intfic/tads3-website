...
layout: docs
---
<span class="title">JumpOffAction</span><span class="type">class</span>
...
`DefineTAction(JumpOff)      `*`// original source text`*  
`class `**`JumpOffAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
