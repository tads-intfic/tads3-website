...
layout: docs
---
<span class="title">RestoreDefaultsAction</span><span class="type">class</span>
...
`DefineSystemAction(RestoreDefaults)      `*`// original source text`*  
`class `**`RestoreDefaultsAction`**` :   `[`SystemAction`](../object/SystemAction.html)*`// after macro expansion`*
