...
layout: docs
---
<span class="title">predicate(ScriptString)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ScriptString)`</span>` :   `[`ScriptStringAction`](../object/ScriptStringAction.html)*`// after macro expansion`*
...
Inherited from `ScriptStringAction` :  
