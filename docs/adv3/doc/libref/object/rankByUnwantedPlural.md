...
layout: docs
---
<span class="title">rankByUnwantedPlural</span><span class="type">object</span>
...
**`rankByUnwantedPlural`**` :   `[`CommandRankingByProblem`](../object/CommandRankingByProblem.html)
