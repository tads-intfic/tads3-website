...
layout: docs
---
<span class="title">predicate(GetOffOf)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(GetOffOf)`</span>` :   `[`GetOffOfAction`](../object/GetOffOfAction.html)*`// after macro expansion`*
...
Inherited from `GetOffOfAction` :  
[`getAllDobj`](../object/GetOffOfAction.html#getAllDobj)
