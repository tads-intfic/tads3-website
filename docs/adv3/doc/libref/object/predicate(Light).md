...
layout: docs
---
<span class="title">predicate(Light)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Light)`</span>` :   `[`LightAction`](../object/LightAction.html)*`// after macro expansion`*
