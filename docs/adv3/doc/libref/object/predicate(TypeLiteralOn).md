...
layout: docs
---
<span class="title">predicate(TypeLiteralOn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TypeLiteralOn)`</span>` :   `[`TypeLiteralOnAction`](../object/TypeLiteralOnAction.html)*`// after macro expansion`*
