...
layout: docs
---
<span class="title">RecordEventsAction</span><span class="type">class</span>
...
`DefineAction(RecordEvents, RecordAction)      `*`// original source text`*  
`class `**`RecordEventsAction`**` :   `[`RecordAction`](../object/RecordAction.html)*`// after macro expansion`*
