...
layout: docs
---
<span class="title">predicate(Wait)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Wait)`</span>` :   `[`WaitAction`](../object/WaitAction.html)*`// after macro expansion`*
...
Inherited from `WaitAction` :  
[`execAction`](../object/WaitAction.html#execAction)
