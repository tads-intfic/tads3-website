...
layout: docs
---
<span class="title">PushPortAction</span><span class="type">class</span>
...
`DefineAction(PushPort, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushPortAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)*`// after macro expansion`*
