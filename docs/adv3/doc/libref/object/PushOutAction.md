...
layout: docs
---
<span class="title">PushOutAction</span><span class="type">class</span>
...
`DefineAction(PushOut, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushOutAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)*`// after macro expansion`*
