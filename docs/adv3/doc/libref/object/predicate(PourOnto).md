...
layout: docs
---
<span class="title">predicate(PourOnto)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PourOnto)`</span>` :   `[`PourOntoAction`](../object/PourOntoAction.html)*`// after macro expansion`*
