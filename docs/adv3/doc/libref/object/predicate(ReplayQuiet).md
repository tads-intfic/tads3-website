...
layout: docs
---
<span class="title">predicate(ReplayQuiet)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ReplayQuiet)`</span>` :   `[`ReplayStringAction`](../object/ReplayStringAction.html)*`// after macro expansion`*
...
[`scriptOptionFlags`](#scriptOptionFlags)



Inherited from `ReplayAction` :  
[`fileDisposition`](../object/ReplayAction.html#fileDisposition)[`filePromptMsg`](../object/ReplayAction.html#filePromptMsg)[`fileTypeID`](../object/ReplayAction.html#fileTypeID)
...
Inherited from `ReplayStringAction` :  
[`execSystemAction`](../object/ReplayStringAction.html#execSystemAction)

Inherited from `ReplayAction` :  
[`performFileOp`](../object/ReplayAction.html#performFileOp)[`showCancelMsg`](../object/ReplayAction.html#showCancelMsg)
...
`scriptOptionFlags`<span class="rem">OVERRIDDEN</span>
