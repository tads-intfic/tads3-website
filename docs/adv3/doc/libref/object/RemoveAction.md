...
layout: docs
---
<span class="title">RemoveAction</span><span class="type">class</span>
...
`DefineTAction(Remove)      `*`// original source text`*  
`class `**`RemoveAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
