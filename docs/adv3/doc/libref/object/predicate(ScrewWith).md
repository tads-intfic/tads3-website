...
layout: docs
---
<span class="title">predicate(ScrewWith)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ScrewWith)`</span>` :   `[`ScrewWithAction`](../object/ScrewWithAction.html)*`// after macro expansion`*
...
Inherited from `ScrewWithAction` :  
[`getAllIobj`](../object/ScrewWithAction.html#getAllIobj)
