...
layout: docs
---
<span class="title">predicate(RecordOff)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(RecordOff)`</span>` :   `[`RecordOffAction`](../object/RecordOffAction.html)`      `*`// after macro expansion`*
