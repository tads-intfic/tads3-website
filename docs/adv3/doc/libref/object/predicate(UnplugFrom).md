...
layout: docs
---
<span class="title">predicate(UnplugFrom)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(UnplugFrom)`</span>` :   `[`UnplugFromAction`](../object/UnplugFromAction.html)*`// after macro expansion`*
