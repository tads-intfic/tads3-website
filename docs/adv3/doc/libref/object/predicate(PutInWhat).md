...
layout: docs
---
<span class="title">predicate(PutInWhat)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PutInWhat)`</span>` :   `[`PutInAction`](../object/PutInAction.html)*`// after macro expansion`*
...
Inherited from `PutInAction` :  
[`getAllDobj`](../object/PutInAction.html#getAllDobj)
