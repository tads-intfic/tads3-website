---
---
<span class="title">EnterAction</span><span class="type">class</span>
...
`DefineTAction(Enter)      `*`// original source text`*  
`class `**`EnterAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
