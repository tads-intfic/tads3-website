...
layout: docs
---
<span class="title">predicate(DigWith)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(DigWith)`</span>` :   `[`DigWithAction`](../object/DigWithAction.html)*`// after macro expansion`*
...
Inherited from `DigWithAction` :  
[`getAllIobj`](../object/DigWithAction.html#getAllIobj)
