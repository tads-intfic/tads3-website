...
layout: docs
---
<span class="title">predicate(Out)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Out)`</span>` :   `[`OutAction`](../object/OutAction.html)*`// after macro expansion`*
...
Inherited from `OutAction` :  
[`getDirection`](../object/OutAction.html#getDirection)
