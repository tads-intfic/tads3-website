...
layout: docs
---
<span class="title">predicate(Enter)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Enter)`</span>` :   `[`EnterAction`](../object/EnterAction.html)*`// after macro expansion`*
