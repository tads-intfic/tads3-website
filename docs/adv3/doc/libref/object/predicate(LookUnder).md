...
layout: docs
---
<span class="title">predicate(LookUnder)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(LookUnder)`</span>` :   `[`LookUnderAction`](../object/LookUnderAction.html)*`// after macro expansion`*
