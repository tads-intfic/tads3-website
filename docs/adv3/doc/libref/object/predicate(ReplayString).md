...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ReplayString)`</span>` :   `[`ReplayStringAction`](../object/ReplayStringAction.html)*`// after macro expansion`*
...
[`scriptOptionFlags`](#scriptOptionFlags) [`verbPhrase`](#verbPhrase)
