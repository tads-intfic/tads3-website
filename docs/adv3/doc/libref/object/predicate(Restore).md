...
layout: docs
---
<span class="title">predicate(Restore)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Restore)`</span>` :   `[`RestoreAction`](../object/RestoreAction.html)*`// after macro expansion`*
