...
layout: docs
---
<span class="title">BoardAction</span><span class="type">class</span>
...
`DefineTAction(Board)      `*`// original source text`*  
`class `**`BoardAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
