...
layout: docs
---
<span class="title">predicate(Travel)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Travel)`</span>` :   `[`TravelAction`](../object/TravelAction.html)*`// after macro expansion`*
