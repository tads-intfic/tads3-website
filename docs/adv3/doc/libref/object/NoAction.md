...
layout: docs
---
<span class="title">NoAction</span><span class="type">class</span>
...
`DefineConvIAction(No)      `*`// original source text`*  
`class `**`NoAction`**` :   `[`ConvIAction`](../object/ConvIAction.html)*`// after macro expansion`*
