...
layout: docs
---
<span class="title">StarboardAction</span><span class="type">class</span>
...
`DefineAction(Starboard, TravelAction)      `*`// original source text`*  
`class `**`StarboardAction`**` :   `[`TravelAction`](../object/TravelAction.html)*`// after macro expansion`*
