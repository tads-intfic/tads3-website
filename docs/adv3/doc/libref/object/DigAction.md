---
---
<span class="title">DigAction</span><span class="type">class</span>
...
`DefineTAction(Dig)      `*`// original source text`*  
`class `**`DigAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
