...
layout: docs
---
<span class="title">predicate(InventoryWide)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(InventoryWide)`</span>` :   `[`InventoryWideAction`](../object/InventoryWideAction.html)*`// after macro expansion`*
...
Inherited from `InventoryWideAction` :  
