---
---
<span class="title">RestoreStringAction</span><span class="type">class</span>
...
string (with the quotes) must be stored in our fname\_ property by
...
`class `**`RestoreStringAction`**` :   `[`RestoreAction`](../object/RestoreAction.html)`      `*`// after macro expansion`*
