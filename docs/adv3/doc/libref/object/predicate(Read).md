...
layout: docs
---
<span class="title">predicate(Read)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Read)`</span>` :   `[`ReadAction`](../object/ReadAction.html)`      `*`// after macro expansion`*
