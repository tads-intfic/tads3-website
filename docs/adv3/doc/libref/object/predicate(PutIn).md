...
layout: docs
---
<span class="title">predicate(PutIn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PutIn)`</span>` :   `[`PutInAction`](../object/PutInAction.html)*`// after macro expansion`*
