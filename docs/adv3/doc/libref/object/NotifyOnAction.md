...
layout: docs
---
<span class="title">NotifyOnAction</span><span class="type">class</span>
...
`DefineSystemAction(NotifyOn)      `*`// original source text`*  
`class `**`NotifyOnAction`**` :   `[`SystemAction`](../object/SystemAction.html)*`// after macro expansion`*
