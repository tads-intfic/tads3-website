---
---
<span class="title">TurnAction</span><span class="type">class</span>
...
`DefineTAction(Turn)      `*`// original source text`*  
`class `**`TurnAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
