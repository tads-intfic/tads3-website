...
layout: docs
---
<span class="title">predicate(AttachToWhat)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(AttachToWhat)`</span>` :   `[`AttachToAction`](../object/AttachToAction.html)*`// after macro expansion`*
