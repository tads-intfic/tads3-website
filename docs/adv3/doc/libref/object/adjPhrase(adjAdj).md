...
layout: docs
---
<span class="title">adjPhrase(adjAdj)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`adjPhrase`](../object/adjPhrase.html)`(adjAdj)`</span>` :   `[`NounPhraseWithVocab`](../object/NounPhraseWithVocab.html)
...
from the underlying adjective phrase
