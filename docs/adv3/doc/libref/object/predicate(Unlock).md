...
layout: docs
---
<span class="title">predicate(Unlock)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Unlock)`</span>` :   `[`UnlockAction`](../object/UnlockAction.html)*`// after macro expansion`*
