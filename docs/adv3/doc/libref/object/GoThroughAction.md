...
layout: docs
---
<span class="title">GoThroughAction</span><span class="type">class</span>
...
`DefineTAction(GoThrough)      `*`// original source text`*  
`class `**`GoThroughAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
