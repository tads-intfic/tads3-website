...
layout: docs
---
<span class="title">predicate(Sit)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Sit)`</span>` :   `[`SitAction`](../object/SitAction.html)*`// after macro expansion`*
...
Inherited from `SitAction` :  
[`execAction`](../object/SitAction.html#execAction)
