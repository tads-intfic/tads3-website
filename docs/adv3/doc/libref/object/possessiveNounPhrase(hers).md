---
---
<span class="title">possessiveNounPhrase(hers)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`possessiveNounPhrase`](../object/possessiveNounPhrase.html)`(hers)`</span>` :   `[`HersNounProd`](../object/HersNounProd.html)
...
Inherited from `HersNounProd` :  
` `[`pronounType`](../object/HersNounProd.html#pronounType)`  `
