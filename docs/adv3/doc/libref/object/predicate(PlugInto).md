...
layout: docs
---
<span class="title">predicate(PlugInto)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(PlugInto)`</span>` :   `[`PlugIntoAction`](../object/PlugIntoAction.html)*`// after macro expansion`*
