...
layout: docs
---
<span class="title">OutAction</span><span class="type">class</span>
...
`DefineAction(Out, TravelAction)      `*`// original source text`*  
`class `**`OutAction`**` :   `[`TravelAction`](../object/TravelAction.html)`      `*`// after macro expansion`*
