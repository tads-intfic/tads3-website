...
layout: docs
---
<span class="title">PushForeAction</span><span class="type">class</span>
...
`DefineAction(PushFore, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushForeAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)*`// after macro expansion`*
