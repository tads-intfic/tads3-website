---
---
<span class="title">predicate(Lie)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Lie)`</span>` :   `[`LieAction`](../object/LieAction.html)`      `*`// after macro expansion`*
...
Inherited from `LieAction` :  
` `[`execAction`](../object/LieAction.html#execAction)`  `
