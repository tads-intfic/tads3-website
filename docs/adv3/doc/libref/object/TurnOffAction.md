...
layout: docs
---
<span class="title">TurnOffAction</span><span class="type">class</span>
...
`DefineTAction(TurnOff)      `*`// original source text`*  
`class `**`TurnOffAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
