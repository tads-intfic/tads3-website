...
layout: docs
---
<span class="title">YourAdjProd</span><span class="type">class</span>
...
`class `**`YourAdjProd`**` :   `[`PossessivePronounAdjProd`](../object/PossessivePronounAdjProd.html)
...
[`canBeAnaphor`](#canBeAnaphor) [`pronounType`](#pronounType)
...
`canBeAnaphor`<span class="rem">OVERRIDDEN</span>
