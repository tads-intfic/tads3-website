...
layout: docs
---
<span class="title">detPluralOnlyNounPhrase(main)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`detPluralOnlyNounPhrase`](../object/detPluralOnlyNounPhrase.html)`(main)`</span>` :   `[`LayeredNounPhraseProd`](../object/LayeredNounPhraseProd.html)
