...
layout: docs
---
<span class="title">PourOntoAction</span><span class="type">class</span>
...
`DefineTIAction(PourOnto)      `*`// original source text`*  
`class `**`PourOntoAction`**` :   `[`TIAction`](../object/TIAction.html)*`// after macro expansion`*
