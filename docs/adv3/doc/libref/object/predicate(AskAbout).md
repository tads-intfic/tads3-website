...
layout: docs
---
<span class="title">predicate(AskAbout)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(AskAbout)`</span>` :   `[`AskAboutAction`](../object/AskAboutAction.html)*`// after macro expansion`*
