...
layout: docs
---
<span class="title">predicate(In)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(In)`</span>` :   `[`InAction`](../object/InAction.html)*`// after macro expansion`*
...
Inherited from `InAction` :  
[`getDirection`](../object/InAction.html#getDirection)
