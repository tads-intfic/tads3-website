...
layout: docs
---
<span class="title">predicate(RecordString)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(RecordString)`</span>` :   `[`RecordStringAction`](../object/RecordStringAction.html)*`// after macro expansion`*
