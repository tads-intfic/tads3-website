...
layout: docs
---
<span class="title">predicate(Lock)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Lock)`</span>` :   `[`LockAction`](../object/LockAction.html)*`// after macro expansion`*
