...
layout: docs
---
<span class="title">OpenAction</span><span class="type">class</span>
...
`DefineTAction(Open)      `*`// original source text`*  
`class `**`OpenAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
