<span class="title">SaveStringAction</span><span class="type">class</span>
...
`class `**`SaveStringAction`**` :   `[`SaveAction`](../object/SaveAction.html)`      `*`// after macro expansion`*
...
Inherited from `SaveAction` :  
` `[`performFileOp`](../object/SaveAction.html#performFileOp)`  `[`showCancelMsg`](../object/SaveAction.html#showCancelMsg)`  `
