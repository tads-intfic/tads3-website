---
---
<span class="title">TopicsAction</span><span class="type">class</span>
...
`DefineSystemAction(Topics)      `*`// original source text`*  
`class `**`TopicsAction`**` :   `[`SystemAction`](../object/SystemAction.html)`      `*`// after macro expansion`*
