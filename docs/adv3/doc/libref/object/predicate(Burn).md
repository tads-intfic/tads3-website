---
---
<span class="title">predicate(Burn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Burn)`</span>` :   `[`BurnAction`](../object/BurnAction.html)`      `*`// after macro expansion`*
