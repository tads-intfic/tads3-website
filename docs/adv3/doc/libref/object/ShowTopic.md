...
layout: docs
---
<span class="title">ShowTopic</span><span class="type">class</span>
...
A SHOW TO topic database entry. This type of topic entry is included in
the SHOW TO list only.

`class `**`ShowTopic`**` :   `[`GiveShowTopic`](../object/GiveShowTopic.html)
