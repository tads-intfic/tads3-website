...
Inherited from `Odor` :  
[`isSmellListedInRoom`](../object/Odor.html#isSmellListedInRoom)[`smellPresence`](../object/Odor.html#smellPresence)
...
Inherited from `Odor` :  
[`cannotSeeSource`](../object/Odor.html#cannotSeeSource)[`dobjFor(Examine)`](../object/Odor.html#dobjFor(Examine))[`dobjFor(Smell)`](../object/Odor.html#dobjFor(Smell))[`smellHereDesc`](../object/Odor.html#smellHereDesc)
