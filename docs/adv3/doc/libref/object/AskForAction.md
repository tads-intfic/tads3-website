...
layout: docs
---
<span class="title">AskForAction</span><span class="type">class</span>
...
`DefineConvTopicTAction(AskFor, IndirectObject)      `*`// original source text`*  
`class `**`AskForAction`**` :   `[`ConvTopicTAction`](../object/ConvTopicTAction.html)*`// after macro expansion`*
