...
layout: docs
---
<span class="title">EastAction</span><span class="type">class</span>
...
`DefineAction(East, TravelAction)      `*`// original source text`*  
`class `**`EastAction`**` :   `[`TravelAction`](../object/TravelAction.html)*`// after macro expansion`*
