...
layout: docs
---
<span class="title">predicate(TipsOn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(TipsOn)`</span>` :   `[`TipModeAction`](../object/TipModeAction.html)*`// after macro expansion`*
