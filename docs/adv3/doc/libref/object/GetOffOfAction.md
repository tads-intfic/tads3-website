---
---
<span class="title">GetOffOfAction</span><span class="type">class</span>
...
`DefineTAction(GetOffOf)      `*`// original source text`*  
`class `**`GetOffOfAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
