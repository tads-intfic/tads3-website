---
---
<span class="title">predicate(LookBehind)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(LookBehind)`</span>` :   `[`LookBehindAction`](../object/LookBehindAction.html)`      `*`// after macro expansion`*
