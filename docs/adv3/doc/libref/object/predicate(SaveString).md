...
layout: docs
---
<span class="title">predicate(SaveString)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(SaveString)`</span>` :   `[`SaveStringAction`](../object/SaveStringAction.html)*`// after macro expansion`*
...
Inherited from `SaveStringAction` :  
