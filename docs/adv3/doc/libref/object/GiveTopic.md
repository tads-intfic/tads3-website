...
layout: docs
---
<span class="title">GiveTopic</span><span class="type">class</span>
...
A GIVE TO topic database entry. This type of topic entry is included in
the GIVE TO list only.

`class `**`GiveTopic`**` :   `[`GiveShowTopic`](../object/GiveShowTopic.html)
