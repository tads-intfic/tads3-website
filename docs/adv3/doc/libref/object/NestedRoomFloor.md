...
layout: docs
---
<span class="title">NestedRoomFloor</span><span class="type">class</span>
...
floor separate from the nested room itself. We simply remap any commands
relating to using the floor as a surface (Put On, Throw At, Sit On, Lie
On, Stand On) to the enclosing nested room.

`class `**`NestedRoomFloor`**` :   `[`Fixture`](../object/Fixture.html)
...
[`dobjFor(LieOn)`](#dobjFor(LieOn))[`dobjFor(SitOn)`](#dobjFor(SitOn))[`dobjFor(StandOn)`](#dobjFor(StandOn))[`iobjFor(PutOn)`](#iobjFor(PutOn))[`iobjFor(ThrowAt)`](#iobjFor(ThrowAt))
...
`iobjFor(ThrowAt)`<span class="rem">OVERRIDDEN</span>
