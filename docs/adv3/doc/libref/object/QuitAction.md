...
layout: docs
---
<span class="title">QuitAction</span><span class="type">class</span>
...
`DefineSystemAction(Quit)      `*`// original source text`*  
`class `**`QuitAction`**` :   `[`SystemAction`](../object/SystemAction.html)*`// after macro expansion`*
...
[`execSystemAction`](#execSystemAction)[`terminateGame`](#terminateGame)
