...
layout: docs
---
<span class="title">PortAction</span><span class="type">class</span>
...
`DefineAction(Port, TravelAction)      `*`// original source text`*  
`class `**`PortAction`**` :   `[`TravelAction`](../object/TravelAction.html)*`// after macro expansion`*
