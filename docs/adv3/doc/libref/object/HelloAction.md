...
layout: docs
---
<span class="title">HelloAction</span><span class="type">class</span>
...
`DefineConvIAction(Hello)      `*`// original source text`*  
`class `**`HelloAction`**` :   `[`ConvIAction`](../object/ConvIAction.html)*`// after macro expansion`*
