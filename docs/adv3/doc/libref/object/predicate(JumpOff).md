...
layout: docs
---
<span class="title">predicate(JumpOff)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(JumpOff)`</span>` :   `[`JumpOffAction`](../object/JumpOffAction.html)*`// after macro expansion`*
