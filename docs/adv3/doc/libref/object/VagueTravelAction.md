---
---
<span class="title">VagueTravelAction</span><span class="type">class</span>
...
`DefineIAction(VagueTravel)      `*`// original source text`*  
`class `**`VagueTravelAction`**` :   `[`IAction`](../object/IAction.html)`      `*`// after macro expansion`*
