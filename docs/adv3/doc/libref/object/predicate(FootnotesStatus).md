...
layout: docs
---
<span class="title">predicate(FootnotesStatus)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(FootnotesStatus)`</span>` :   `[`FootnotesStatusAction`](../object/FootnotesStatusAction.html)*`// after macro expansion`*
...
Inherited from `FootnotesStatusAction` :  
