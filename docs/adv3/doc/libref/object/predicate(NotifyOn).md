...
layout: docs
---
<span class="title">predicate(NotifyOn)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(NotifyOn)`</span>` :   `[`NotifyOnAction`](../object/NotifyOnAction.html)*`// after macro expansion`*
