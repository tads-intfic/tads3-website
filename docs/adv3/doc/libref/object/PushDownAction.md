...
`DefineAction(PushDown, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushDownAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)`      `*`// after macro expansion`*
