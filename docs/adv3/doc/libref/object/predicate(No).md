...
layout: docs
---
<span class="title">predicate(No)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(No)`</span>` :   `[`NoAction`](../object/NoAction.html)*`// after macro expansion`*
...
Inherited from `NoAction` :  
[`execAction`](../object/NoAction.html#execAction)
