...
layout: docs
---
<span class="title">spelledSmallNumber(zero)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`spelledSmallNumber`](../object/spelledSmallNumber.html)`(zero)`</span>` :   `[`NumberProd`](../object/NumberProd.html)
