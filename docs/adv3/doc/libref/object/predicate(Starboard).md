...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Starboard)`</span>` :   `[`StarboardAction`](../object/StarboardAction.html)*`// after macro expansion`*
...
Inherited from `StarboardAction` :  
