...
layout: docs
---
<span class="title">UpAction</span><span class="type">class</span>
...
`DefineAction(Up, TravelAction)      `*`// original source text`*  
`class `**`UpAction`**` :   `[`TravelAction`](../object/TravelAction.html)*`// after macro expansion`*
