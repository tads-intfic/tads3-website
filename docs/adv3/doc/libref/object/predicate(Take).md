...
layout: docs
---
<span class="title">predicate(Take)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Take)`</span>` :   `[`TakeAction`](../object/TakeAction.html)*`// after macro expansion`*
...
Inherited from `TakeAction` :  
[`getAllDobj`](../object/TakeAction.html#getAllDobj)
