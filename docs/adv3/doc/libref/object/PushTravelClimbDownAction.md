...
layout: docs
---
<span class="title">PushTravelClimbDownAction</span><span class="type">class</span>
...
`DefineTIActionSub(PushTravelClimbDown, PushTravelViaIobjAction)      `*`// original source text`*  
`class `**`PushTravelClimbDownAction`**` :   `[`PushTravelViaIobjAction`](../object/PushTravelViaIobjAction.html)*`// after macro expansion`*
...
`performTravel ( )`<span class="rem">OVERRIDDEN</span>
