...
layout: docs
---
<span class="title">TypeOnAction</span><span class="type">class</span>
...
`DefineTAction(TypeOn)      `*`// original source text`*  
`class `**`TypeOnAction`**` :   `[`TAction`](../object/TAction.html)*`// after macro expansion`*
