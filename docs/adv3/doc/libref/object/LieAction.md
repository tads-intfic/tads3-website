...
layout: docs
---
<span class="title">LieAction</span><span class="type">class</span>
...
`DefineIAction(Lie)      `*`// original source text`*  
`class `**`LieAction`**` :   `[`IAction`](../object/IAction.html)*`// after macro expansion`*
