...
to achieve the same effect. <span id="opc_idxint8"></span>
...
the integer value given by *index_val*. <span id="opc_new1"></span>
...
accordingly. <span id="opc_new2"></span>
...
Stack: *same as* [NEW1](#opc_new1) <span id="opc_declcl"></span>
...
doing so would be faster. <span id="opc_addilcl1"></span>
...
local variable at index *local_number*. <span id="opc_addilcl4"></span>
...
the local variable at index *local_number*, using the same algorithm
that the [ADD](#opc_add) instruction uses. Assign the result to the
local variable at index *local_number*. <span id="opc_addtolcl"></span>
...
*local_number*. <span id="opc_subfromlcl"></span>
...
instruction uses. Assign the result to the local variable at index
*local_number*. <span id="opc_zerolcl1"></span>
...
Sets the given local to zero. <span id="opc_zerolcl2"></span>
...
Sets the given local to zero. <span id="opc_nillcl1"></span>
...
Sets the given local to nil. <span id="opc_nillcl2"></span>
...
Sets the given local to nil. <span id="opc_onelcl1"></span>
...
data. <span id="opc_setpropself"></span>
...
from the stack. <span id="opc_objsetprop"></span>
...
than popping an object from the stack. <span id="opc_setdblcl"></span>
...
stack_level means. <span id="opc_setdbarg"></span>
...
effect. <span id="opc_storectx"></span>
...
with the method context values. <span id="opc_setlcl1r0"></span>
...
variable at index *local_number*. <span id="opc_setindlcl1i8"></span>
