...
<a href="depth.htm" class="nav">TADS 3 In Depth</a> \> Where Messages
Come From  
<span class="navnp"><a href="depth.htm" class="nav"><em>Prev:</em> TADS 3 In Depth</a>
    <a href="t3res.htm" class="nav"><em>Next:</em> Action Results</a>
    </span>
...
the [Action](t3res.htm#action) section of the article on
<span href't3res.htm'="">Action Results.</span>
