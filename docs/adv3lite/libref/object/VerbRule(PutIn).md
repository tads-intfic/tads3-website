...
layout: docs
---
<span class="title">VerbRule(PutIn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PutIn)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
