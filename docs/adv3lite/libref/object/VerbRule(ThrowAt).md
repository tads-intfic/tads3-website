...
layout: docs
---
<span class="title">VerbRule(ThrowAt)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ThrowAt)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
