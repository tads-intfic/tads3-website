...
layout: docs
---
<span class="title">VerbRule(Notify)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Notify)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
