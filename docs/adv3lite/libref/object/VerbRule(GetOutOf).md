...
layout: docs
---
<span class="title">VerbRule(GetOutOf)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(GetOutOf)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
