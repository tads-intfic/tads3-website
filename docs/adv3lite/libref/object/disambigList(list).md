...
layout: docs
---
<span class="title">disambigList(list)</span><span class="type">grammar</span>
...
`grammar `**[`disambigList`](../object/disambigList.html)`(list)`**` :   `[`NounListProduction`](../object/NounListProduction.html)
