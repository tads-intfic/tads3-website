...
layout: docs
---
<span class="title">VerbRule(Verbose)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Verbose)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
