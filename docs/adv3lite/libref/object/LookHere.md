...
layout: docs
---
<span class="title">LookHere</span><span class="type">object</span>
...
Trap commands like LOOK HERE or SEARCH THERE. We'll actually carry out a
LOOK command, but we'll also tell the player just to use LOOK in future.

**`LookHere`**` :   `[`IAction`](../object/IAction.html)
...
[newbie.t](../file/newbie.t.html)\[[417](../source/newbie.t.html#417)\]
