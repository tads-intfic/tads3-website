...
layout: docs
---
<span class="title">VerbRule(ConsultWhatAbout)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ConsultWhatAbout)`**` :   `[`VerbProduction`](../object/VerbProduction.html)*`// after macro expansion`*
