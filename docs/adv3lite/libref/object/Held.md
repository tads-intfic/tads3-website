...
container, in the sense of a person holding an object in her hands. An
object being held is exterior to the holder, not enclosed.

**`Held`**` :   `[`ExtLocType`](../object/ExtLocType.html)
...
[english.t](../file/english.t.html)\[[5720](../source/english.t.html#5720)\]
