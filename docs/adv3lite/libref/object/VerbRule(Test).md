...
layout: docs
---
<span class="title">VerbRule(Test)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Test)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
