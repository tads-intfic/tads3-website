...
layout: docs
---
<span class="title">VerbRule(TypeLiteralOnWhat)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(TypeLiteralOnWhat)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
