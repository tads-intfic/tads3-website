[qualifiedSingularNounPhrase(indefinite)]{.title}[grammar]{.type}
...
`grammar `**[`qualifiedSingularNounPhrase`](../object/qualifiedSingularNounPhrase.html)`(indefinite)`**` :   `[`Production`](../object/Production.html)
:::
