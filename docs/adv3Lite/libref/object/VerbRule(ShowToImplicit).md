...
layout: docs
---
<span class="title">VerbRule(ShowToImplicit)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ShowToImplicit)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
