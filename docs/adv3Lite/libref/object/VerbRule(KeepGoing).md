...
layout: docs
---
<span class="title">VerbRule(KeepGoing)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(KeepGoing)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
