...
layout: docs
---
<span class="title">VerbRule(FiatLux)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(FiatLux)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
