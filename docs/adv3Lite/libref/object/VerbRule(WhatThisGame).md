[VerbRule(WhatThisGame)]{.title}[grammar]{.type}
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(WhatThisGame)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
:::
