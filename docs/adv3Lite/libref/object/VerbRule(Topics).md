---
---
<span class="title">VerbRule(Topics)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Topics)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
