---
---
<span class="title">ConsultAbout</span><span class="type">object</span>
...
**`ConsultAbout`**` :   `[`TopicTAction`](../object/TopicTAction.html)
...
Inherited from `TopicTAction` :  
` `[`execAction`](../object/TopicTAction.html#execAction)`  `[`resolvePronouns`](../object/TopicTAction.html#resolvePronouns)`  `[`verify`](../object/TopicTAction.html#verify)`  `
...
[actions.t](../file/actions.t.html)\[[1481](../source/actions.t.html#1481)\]
