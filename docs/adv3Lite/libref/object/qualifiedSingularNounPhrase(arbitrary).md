[qualifiedSingularNounPhrase(arbitrary)]{.title}[grammar]{.type}
...
`grammar `**[`qualifiedSingularNounPhrase`](../object/qualifiedSingularNounPhrase.html)`(arbitrary)`**` :   `[`Production`](../object/Production.html)
:::
