[possessiveNounPhrase(his)]{.title}[grammar]{.type}
...
`grammar `**[`possessiveNounPhrase`](../object/possessiveNounPhrase.html)`(his)`**` :   `[`PossessiveProduction`](../object/PossessiveProduction.html)
:::
