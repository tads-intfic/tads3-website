---
---
<span class="title">VerbRule(GoTo)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(GoTo)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
...
` `[`action`](#action)`  `[`dobjReply`](#dobjReply)`  `[`missingQ`](#missingQ)`  `[`priority`](#priority)`  `[`verbPhrase`](#verbPhrase)`  `
