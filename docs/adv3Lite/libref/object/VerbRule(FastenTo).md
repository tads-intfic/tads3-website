...
layout: docs
---
<span class="title">VerbRule(FastenTo)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(FastenTo)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
