...
layout: docs
---
<span class="title">VerbRule(Drop)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Drop)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
