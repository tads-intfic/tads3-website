...
layout: docs
---
<span class="title">VerbRule(Examine)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Examine)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
