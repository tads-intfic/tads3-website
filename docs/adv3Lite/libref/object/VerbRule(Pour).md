---
---
<span class="title">VerbRule(Pour)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Pour)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
