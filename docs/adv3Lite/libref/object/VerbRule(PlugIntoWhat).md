...
layout: docs
---
<span class="title">VerbRule(PlugIntoWhat)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PlugIntoWhat)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
