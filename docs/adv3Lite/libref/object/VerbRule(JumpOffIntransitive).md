...
layout: docs
---
<span class="title">VerbRule(JumpOffIntransitive)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(JumpOffIntransitive)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
