...
layout: docs
---
<span class="title">VerbRule(Wear)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Wear)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
