...
layout: docs
---
<span class="title">VerbRule(Search)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Search)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
