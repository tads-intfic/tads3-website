...
::: fdesc
Each instance must override execute() with its specific post-undo code.

**`Quit`**` :   `[`SystemAction`](../object/SystemAction.html)
:::
...
[actions.t](../file/actions.t.html)\[[22](../source/actions.t.html#22)\]
