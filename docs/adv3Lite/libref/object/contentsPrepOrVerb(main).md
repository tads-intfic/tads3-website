...
layout: docs
---
<span class="title">contentsPrepOrVerb(main)</span><span class="type">grammar</span>
...
`grammar `**[`contentsPrepOrVerb`](../object/contentsPrepOrVerb.html)`(main)`**` :   `[`Production`](../object/Production.html)
