...
layout: docs
---
<span class="title">VerbRule(Query)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Query)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
