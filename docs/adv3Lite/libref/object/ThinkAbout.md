...
layout: docs
---
<span class="title">ThinkAbout</span><span class="type">object</span>
...
**`ThinkAbout`**` :   `[`TopicAction`](../object/TopicAction.html)
...
` `[`againRepeatsParse`](#againRepeatsParse)`  `[`baseActionClass`](#baseActionClass)`  `
...
[actions.t](../file/actions.t.html)\[[1986](../source/actions.t.html#1986)\]
