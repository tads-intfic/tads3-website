...
layout: docs
---
<span class="title">VerbRule(Say)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Say)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
