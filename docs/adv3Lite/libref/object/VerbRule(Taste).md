...
layout: docs
---
<span class="title">VerbRule(Taste)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Taste)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
