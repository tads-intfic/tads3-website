...
layout: docs
---
<span class="title">VerbRule(PushTravelClimbUp)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PushTravelClimbUp)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
