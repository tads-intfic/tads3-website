[pluralPhraseWithContents(basic)]{.title}[grammar]{.type}
...
`grammar `**[`pluralPhraseWithContents`](../object/pluralPhraseWithContents.html)`(basic)`**` :   `[`Production`](../object/Production.html)
:::
