[possessiveAdjPhrase(their)]{.title}[grammar]{.type}
...
`grammar `**[`possessiveAdjPhrase`](../object/possessiveAdjPhrase.html)`(their)`**` :   `[`PossessiveProduction`](../object/PossessiveProduction.html)
:::
