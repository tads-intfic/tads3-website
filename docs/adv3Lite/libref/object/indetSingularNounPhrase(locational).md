[indetSingularNounPhrase(locational)]{.title}[grammar]{.type}
...
`grammar `**[`indetSingularNounPhrase`](../object/indetSingularNounPhrase.html)`(locational)`**` :   `[`LocationalProduction`](../object/LocationalProduction.html)
:::
