[explicitDetPluralNounPhrase(definite)]{.title}[grammar]{.type}
...
`grammar `**[`explicitDetPluralNounPhrase`](../object/explicitDetPluralNounPhrase.html)`(definite)`**` :   `[`Production`](../object/Production.html)
:::
