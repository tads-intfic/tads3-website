...
layout: docs
---
<span class="title">VerbRule(Seek)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Seek)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
