...
layout: docs
---
<span class="title">VerbRule(DetachFrom)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(DetachFrom)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
