...
layout: docs
---
<span class="title">VerbRule(TurnTo)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(TurnTo)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
