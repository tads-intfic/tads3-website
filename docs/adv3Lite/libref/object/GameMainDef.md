...
inherit everything else from the GameMainDef class if you don\'t require
...
set this to nil. It\'s a trade-off though, as some people will think
your game is less player-friendly if you disable ALL.
:::
...
define this to refer to the Actor object that serves as the initial
player character.
:::
