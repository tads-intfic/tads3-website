[qualifiedSingularNounPhrase(definite)]{.title}[grammar]{.type}
...
`grammar `**[`qualifiedSingularNounPhrase`](../object/qualifiedSingularNounPhrase.html)`(definite)`**` :   `[`Production`](../object/Production.html)
:::
