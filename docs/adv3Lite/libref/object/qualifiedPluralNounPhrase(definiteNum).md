...
layout: docs
---
<span class="title">qualifiedPluralNounPhrase(definiteNum)</span><span class="type">grammar</span>
...
`grammar `**[`qualifiedPluralNounPhrase`](../object/qualifiedPluralNounPhrase.html)`(definiteNum)`**` :   `[`QuantifierProduction`](../object/QuantifierProduction.html)
