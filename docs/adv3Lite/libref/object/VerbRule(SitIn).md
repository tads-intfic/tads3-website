...
layout: docs
---
<span class="title">VerbRule(SitIn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(SitIn)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
