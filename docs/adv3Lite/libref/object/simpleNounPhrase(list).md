...
layout: docs
---
<span class="title">simpleNounPhrase(list)</span><span class="type">grammar</span>
...
`grammar `**[`simpleNounPhrase`](../object/simpleNounPhrase.html)`(list)`**` :   `[`Production`](../object/Production.html)
