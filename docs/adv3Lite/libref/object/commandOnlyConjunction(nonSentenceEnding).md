[commandOnlyConjunction(nonSentenceEnding)]{.title}[grammar]{.type}
...
`grammar `**[`commandOnlyConjunction`](../object/commandOnlyConjunction.html)`(nonSentenceEnding)`**` :   `[`Production`](../object/Production.html)
:::
