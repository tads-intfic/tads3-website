...
layout: docs
---
<span class="title">VerbRule(Attack)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Attack)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
