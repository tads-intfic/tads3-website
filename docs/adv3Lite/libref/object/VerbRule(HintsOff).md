...
layout: docs
---
<span class="title">VerbRule(HintsOff)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(HintsOff)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
