...
layout: docs
---
<span class="title">VerbRule(Doff)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Doff)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
