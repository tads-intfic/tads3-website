...
layout: docs
---
<span class="title">VerbRule(SaveString)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(SaveString)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
