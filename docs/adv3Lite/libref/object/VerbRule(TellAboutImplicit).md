[VerbRule(TellAboutImplicit)]{.title}[grammar]{.type}
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(TellAboutImplicit)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
:::
