...
layout: docs
---
<span class="title">VerbRule(PlugInto)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PlugInto)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
