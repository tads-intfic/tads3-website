...
layout: docs
---
<span class="title">VerbRule(Unscrew)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Unscrew)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
