---
---
<span class="title">VerbRule(Unlock)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Unlock)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
