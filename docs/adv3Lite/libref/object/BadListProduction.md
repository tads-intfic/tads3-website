[BadListProduction]{.title}[class]{.type}
...
us, because we can\'t put something in two places at once. This class
can be used for a grammar rule that parses a list where a single noun is
