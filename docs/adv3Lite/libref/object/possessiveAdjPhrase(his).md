[possessiveAdjPhrase(his)]{.title}[grammar]{.type}
...
`grammar `**[`possessiveAdjPhrase`](../object/possessiveAdjPhrase.html)`(his)`**` :   `[`PossessiveProduction`](../object/PossessiveProduction.html)
:::
