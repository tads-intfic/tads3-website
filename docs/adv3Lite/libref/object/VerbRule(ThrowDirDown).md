...
layout: docs
---
<span class="title">VerbRule(ThrowDirDown)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ThrowDirDown)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
