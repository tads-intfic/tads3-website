[implicitDetPluralOnlyNounPhrase(main)]{.title}[grammar]{.type}
...
`grammar `**[`implicitDetPluralOnlyNounPhrase`](../object/implicitDetPluralOnlyNounPhrase.html)`(main)`**` :   `[`Production`](../object/Production.html)
:::
