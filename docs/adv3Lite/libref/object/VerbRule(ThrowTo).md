...
layout: docs
---
<span class="title">VerbRule(ThrowTo)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ThrowTo)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
