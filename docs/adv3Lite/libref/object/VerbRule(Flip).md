...
layout: docs
---
<span class="title">VerbRule(Flip)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Flip)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
