...
layout: docs
---
<span class="title">VerbRule(LookBehind)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(LookBehind)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
