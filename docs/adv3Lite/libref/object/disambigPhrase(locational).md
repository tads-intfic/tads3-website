...
layout: docs
---
<span class="title">disambigPhrase(locational)</span><span class="type">grammar</span>
...
`grammar `**[`disambigPhrase`](../object/disambigPhrase.html)`(locational)`**` :   `[`LocationalProduction`](../object/LocationalProduction.html)
