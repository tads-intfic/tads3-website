...
layout: docs
---
<span class="title">VerbRule(Purloin)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Purloin)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
