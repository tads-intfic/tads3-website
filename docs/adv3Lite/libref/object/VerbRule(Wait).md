...
layout: docs
---
<span class="title">VerbRule(Wait)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Wait)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
