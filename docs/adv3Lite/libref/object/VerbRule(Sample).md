...
layout: docs
---
<span class="title">VerbRule(Sample)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Sample)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
