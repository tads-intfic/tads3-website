...
layout: docs
---
<span class="title">VerbRule(Open)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Open)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
