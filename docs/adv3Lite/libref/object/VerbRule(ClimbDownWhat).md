---
---
<span class="title">VerbRule(ClimbDownWhat)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ClimbDownWhat)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
...
` `[`action`](#action)`  `[`dobjReply`](#dobjReply)`  `[`verbPhrase`](#verbPhrase)`  `
