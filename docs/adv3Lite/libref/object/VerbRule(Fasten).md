...
layout: docs
---
<span class="title">VerbRule(Fasten)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Fasten)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
