...
layout: docs
---
<span class="title">VerbRule(Drink)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Drink)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
