...
layout: docs
---
<span class="title">VerbRule(LockWith)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(LockWith)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
