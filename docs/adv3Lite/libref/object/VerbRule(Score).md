...
layout: docs
---
<span class="title">VerbRule(Score)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Score)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
