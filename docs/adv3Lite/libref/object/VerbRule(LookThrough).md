...
layout: docs
---
<span class="title">VerbRule(LookThrough)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(LookThrough)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
