...
layout: docs
---
<span class="title">VerbRule(Feel)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Feel)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
