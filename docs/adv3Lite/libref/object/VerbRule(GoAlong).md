---
---
<span class="title">VerbRule(GoAlong)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(GoAlong)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
