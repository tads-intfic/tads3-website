...
layout: docs
---
<span class="title">VerbRule(Yell)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Yell)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
