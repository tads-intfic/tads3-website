...
layout: docs
---
<span class="title">VerbRule(PourOnto)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PourOnto)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
