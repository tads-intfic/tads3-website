...
layout: docs
---
<span class="title">VerbRule(PlugIn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PlugIn)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
