...
layout: docs
---
<span class="title">VerbRule(Save)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Save)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
