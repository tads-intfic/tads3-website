[VerbRule(AttackWith)]{.title}[grammar]{.type}
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(AttackWith)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
:::
