...
layout: docs
---
<span class="title">VerbRule(MoveTo)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(MoveTo)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
