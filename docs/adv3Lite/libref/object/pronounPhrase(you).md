...
layout: docs
---
<span class="title">pronounPhrase(you)</span><span class="type">grammar</span>
...
`grammar `**[`pronounPhrase`](../object/pronounPhrase.html)`(you)`**` :   `[`PronounProduction`](../object/PronounProduction.html)
