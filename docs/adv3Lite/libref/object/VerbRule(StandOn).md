...
layout: docs
---
<span class="title">VerbRule(StandOn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(StandOn)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
