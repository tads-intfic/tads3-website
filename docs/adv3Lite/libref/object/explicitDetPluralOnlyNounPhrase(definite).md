[explicitDetPluralOnlyNounPhrase(definite)]{.title}[grammar]{.type}
...
`grammar `**[`explicitDetPluralOnlyNounPhrase`](../object/explicitDetPluralOnlyNounPhrase.html)`(definite)`**` :   `[`Production`](../object/Production.html)
:::
