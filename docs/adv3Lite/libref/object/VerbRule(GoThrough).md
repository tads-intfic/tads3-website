...
layout: docs
---
<span class="title">VerbRule(GoThrough)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(GoThrough)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
