[EndOfFileException]{.title}[class]{.type}
...
::: fdesc
End-of-file exception - this is thrown when readMainCommand() encounters
end of file reading the console input.

`class `**`EndOfFileException`**` :   `[`Exception`](../object/Exception.html)
:::
