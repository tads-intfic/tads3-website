...
layout: docs
---
<span class="title">simpleNounPhrase(adjAndOnes)</span><span class="type">grammar</span>
...
`grammar `**[`simpleNounPhrase`](../object/simpleNounPhrase.html)`(adjAndOnes)`**` :   `[`Production`](../object/Production.html)
