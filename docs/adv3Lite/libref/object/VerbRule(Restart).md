...
layout: docs
---
<span class="title">VerbRule(Restart)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Restart)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
