---
---
<span class="title">VerbRule(ReplayString)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ReplayString)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
...
` `[`action`](#action)`  `[`scriptOptionFlags`](#scriptOptionFlags)`  `[`verbPhrase`](#verbPhrase)`  `
