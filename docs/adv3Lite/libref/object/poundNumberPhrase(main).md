[poundNumberPhrase(main)]{.title}[grammar]{.type}
...
`grammar `**[`poundNumberPhrase`](../object/poundNumberPhrase.html)`(main)`**` :   `[`NumberNounProduction`](../object/NumberNounProduction.html)
:::
