...
layout: docs
---
<span class="title">VerbRule(WhereAmI)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(WhereAmI)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
