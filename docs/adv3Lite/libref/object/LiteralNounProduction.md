---
---
<span class="title">LiteralNounProduction</span><span class="type">class</span>
...
LiteralNounProduction is a Production subclass for a literal phrase that
serves as a direct, indirect, or accessory object.

`class `**`LiteralNounProduction`**` :   `[`Production`](../object/Production.html)
