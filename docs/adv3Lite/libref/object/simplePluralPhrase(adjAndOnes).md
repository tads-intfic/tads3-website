[simplePluralPhrase(adjAndOnes)]{.title}[grammar]{.type}
...
`grammar `**[`simplePluralPhrase`](../object/simplePluralPhrase.html)`(adjAndOnes)`**` :   `[`Production`](../object/Production.html)
:::
