---
---
<span class="title">VerbRule(Climb)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Climb)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
