...
layout: docs
---
<span class="title">VerbRule(PutUnder)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PutUnder)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
