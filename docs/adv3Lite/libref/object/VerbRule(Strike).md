---
---
<span class="title">VerbRule(Strike)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Strike)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
