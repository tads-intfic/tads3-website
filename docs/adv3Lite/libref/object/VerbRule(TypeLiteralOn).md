...
layout: docs
---
<span class="title">VerbRule(TypeLiteralOn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(TypeLiteralOn)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
