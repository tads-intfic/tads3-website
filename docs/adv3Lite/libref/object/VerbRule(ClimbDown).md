...
layout: docs
---
<span class="title">VerbRule(ClimbDown)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ClimbDown)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
