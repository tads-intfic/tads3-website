...
layout: docs
---
<span class="title">pluralPhraseWithContents(contents)</span><span class="type">grammar</span>
...
`grammar `**[`pluralPhraseWithContents`](../object/pluralPhraseWithContents.html)`(contents)`**` :   `[`ContentsQualifierProduction`](../object/ContentsQualifierProduction.html)
