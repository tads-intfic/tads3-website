[possessiveAdjPhrase(npApostropheS)]{.title}[grammar]{.type}
...
`grammar `**[`possessiveAdjPhrase`](../object/possessiveAdjPhrase.html)`(npApostropheS)`**` :   `[`PossessiveProduction`](../object/PossessiveProduction.html)
:::
