[firstCommandPhrase(commandOnly)]{.title}[grammar]{.type}
...
`grammar `**[`firstCommandPhrase`](../object/firstCommandPhrase.html)`(commandOnly)`**` :   `[`CommandProduction`](../object/CommandProduction.html)
:::
