...
layout: docs
---
<span class="title">VerbRule(ExitsMode)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ExitsMode)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
