---
---
<span class="title">VerbRule(RecordEventsString)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(RecordEventsString)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
