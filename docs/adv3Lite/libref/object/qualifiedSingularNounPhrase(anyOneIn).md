[qualifiedSingularNounPhrase(anyOneIn)]{.title}[grammar]{.type}
...
`grammar `**[`qualifiedSingularNounPhrase`](../object/qualifiedSingularNounPhrase.html)`(anyOneIn)`**` :   `[`LocationalProduction`](../object/LocationalProduction.html)
:::
