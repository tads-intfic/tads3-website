[completeNounPhraseWithAll(main)]{.title}[grammar]{.type}
...
`grammar `**[`completeNounPhraseWithAll`](../object/completeNounPhraseWithAll.html)`(main)`**` :   `[`Production`](../object/Production.html)
:::
