[ListRelations]{.title}[object]{.type}
...
**`ListRelations`**` :   `[`SystemAction`](../object/SystemAction.html)
:::
...
` `[`execAction`](#execAction)`  `[`showRelation`](#showRelation)`  `
...
[relations.t](../file/relations.t.html)\[[764](../source/relations.t.html#764)\]
...
[relations.t](../file/relations.t.html)\[[802](../source/relations.t.html#802)\]
