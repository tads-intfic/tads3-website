...
layout: docs
---
<span class="title">VerbRule(SayTo)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(SayTo)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
