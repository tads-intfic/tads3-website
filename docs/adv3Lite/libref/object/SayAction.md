...
layout: docs
---
<span class="title">SayAction</span><span class="type">object</span>
...
` `[`isConversational`](../object/ImplicitConversationAction.html#isConversational)`  `[`topics`](../object/ImplicitConversationAction.html#topics)`  `
...
`defaultProperty`<span class="rem">OVERRIDDEN</span>
