---
---
<span class="title">simpleNounPhrase(literalAndList)</span><span class="type">grammar</span>
...
`grammar `**[`simpleNounPhrase`](../object/simpleNounPhrase.html)`(literalAndList)`**` :   `[`Production`](../object/Production.html)
