...
layout: docs
---
<span class="title">VerbRule(TurnWith)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(TurnWith)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
