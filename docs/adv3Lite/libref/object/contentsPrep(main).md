...
layout: docs
---
<span class="title">contentsPrep(main)</span><span class="type">grammar</span>
...
`grammar `**[`contentsPrep`](../object/contentsPrep.html)`(main)`**` :   `[`Production`](../object/Production.html)
