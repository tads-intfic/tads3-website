---
---
<span class="title">VerbRule(GoNear)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(GoNear)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
