...
layout: docs
---
<span class="title">VerbRule(EnterOn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(EnterOn)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
