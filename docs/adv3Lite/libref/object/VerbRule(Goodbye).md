...
layout: docs
---
<span class="title">VerbRule(Goodbye)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Goodbye)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
