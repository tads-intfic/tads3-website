---
---
<span class="title">VerbRule(TellTo)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(TellTo)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
