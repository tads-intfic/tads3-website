---
---
<span class="title">VerbRule(RelationDetails)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(RelationDetails)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
