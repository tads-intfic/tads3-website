...
layout: docs
---
<span class="title">nounPhraseWithContents(contents)</span><span class="type">grammar</span>
...
`grammar `**[`nounPhraseWithContents`](../object/nounPhraseWithContents.html)`(contents)`**` :   `[`ContentsQualifierProduction`](../object/ContentsQualifierProduction.html)
