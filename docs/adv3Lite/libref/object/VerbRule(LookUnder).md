---
---
<span class="title">VerbRule(LookUnder)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(LookUnder)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
