...
layout: docs
---
<span class="title">VerbRule(Push)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Push)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
