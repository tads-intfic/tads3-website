...
layout: docs
---
<span class="title">VerbRule(QueryVague)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(QueryVague)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
