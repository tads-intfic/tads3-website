[VerbRule(PushTravelDir)]{.title}[grammar]{.type}
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PushTravelDir)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
:::
