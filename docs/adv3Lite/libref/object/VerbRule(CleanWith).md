...
layout: docs
---
<span class="title">VerbRule(CleanWith)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(CleanWith)`**` :   `[`VerbProduction`](../object/VerbProduction.html)*`// after macro expansion`*
