...
layout: docs
---
<span class="title">pronounPhrase(me)</span><span class="type">grammar</span>
...
`grammar `**[`pronounPhrase`](../object/pronounPhrase.html)`(me)`**` :   `[`PronounProduction`](../object/PronounProduction.html)
