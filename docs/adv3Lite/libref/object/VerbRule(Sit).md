...
layout: docs
---
<span class="title">VerbRule(Sit)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Sit)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
