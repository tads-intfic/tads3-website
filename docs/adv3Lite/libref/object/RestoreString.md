[RestoreString]{.title}[object]{.type}
...
**`RestoreString`**` :   `[`Action`](../object/Action.html)
:::
...
[actions.t](../file/actions.t.html)\[[2979](../source/actions.t.html#2979)\]
