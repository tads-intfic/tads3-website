...
layout: docs
---
<span class="title">qualifiedPluralNounPhrase(determiner)</span><span class="type">grammar</span>
...
`grammar `**[`qualifiedPluralNounPhrase`](../object/qualifiedPluralNounPhrase.html)`(determiner)`**` :   `[`Production`](../object/Production.html)
