...
layout: docs
---
<span class="title">VerbRule(UnlockWith)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(UnlockWith)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
