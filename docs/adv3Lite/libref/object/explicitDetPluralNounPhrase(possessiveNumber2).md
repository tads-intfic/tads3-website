...
layout: docs
---
<span class="title">explicitDetPluralNounPhrase(possessiveNumber2)</span><span class="type">grammar</span>
...
`grammar `**[`explicitDetPluralNounPhrase`](../object/explicitDetPluralNounPhrase.html)`(possessiveNumber2)`**` :   `[`QuantifierProduction`](../object/QuantifierProduction.html)
