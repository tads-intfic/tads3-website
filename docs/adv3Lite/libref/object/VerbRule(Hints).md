---
---
<span class="title">VerbRule(Hints)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Hints)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
