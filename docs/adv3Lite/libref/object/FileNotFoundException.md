[FileNotFoundException]{.title}[class]{.type}
...
reading and the file doesn\'t exist or can\'t be opened (because the
user doesn\'t have privileges to read the file, or the file is already
being used by another user, for example).

`class `**`FileNotFoundException`**` :   `[`FileException`](../object/FileException.html)
:::
...
[file.t](../file/file.t.html)\[[103](../source/file.t.html#103)\]
