...
layout: docs
---
<span class="title">VerbRule(Turn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Turn)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
