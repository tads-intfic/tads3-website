...
layout: docs
---
<span class="title">qualifiedSingularNounPhrase(theOneContaining)</span><span class="type">grammar</span>
...
`grammar `**[`qualifiedSingularNounPhrase`](../object/qualifiedSingularNounPhrase.html)`(theOneContaining)`**` :   `[`ContentsQualifierProduction`](../object/ContentsQualifierProduction.html)
...
Inherited from `ContentsQualifierProduction` :  
