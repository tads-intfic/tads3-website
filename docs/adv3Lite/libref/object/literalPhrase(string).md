[literalPhrase(string)]{.title}[grammar]{.type}
...
`grammar `**[`literalPhrase`](../object/literalPhrase1.html)`(string)`**` :   `[`LiteralNounProduction`](../object/LiteralNounProduction.html)
:::
