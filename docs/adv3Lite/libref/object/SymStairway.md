...
point a direction property of the room at one end of the SymStairway to
point to the SymStairway and define the SymStairwa\'s room2 or
destination propety to be its other end.

If the SymStairway is defined on the up or down property of either of
its ends, either directtly or indirectly, then this extension can work
out which end of the Stairway is which (even if the up or down property
points to the SymStairway indirectly via an asExit() macro) Otherwise
game code needs to define at least one of the SymStairway\'s upperEnd or
lowerEnd properties to point to the appropriate room.

\[THE SYMCONN EXIENSION must be present in your project if you want to
use a SymStairway\]
...
` `[`canGoThroughMe`](../object/SymPassage.html#canGoThroughMe)`  `[`isFixed`](../object/SymPassage.html#isFixed)`  `[`room1Desc`](../object/SymPassage.html#room1Desc)`  `[`room1Vocab`](../object/SymPassage.html#room1Vocab)`  `[`room2Desc`](../object/SymPassage.html#room2Desc)`  `[`room2Vocab`](../object/SymPassage.html#room2Vocab)`  `

Inherited from `MultiLoc` :\
` `[`exceptions`](../object/MultiLoc.html#exceptions)`  `[`initialLocationClass`](../object/MultiLoc.html#initialLocationClass)`  `[`initialLocationList`](../object/MultiLoc.html#initialLocationList)`  `[`locationList`](../object/MultiLoc.html#locationList)`  `

Inherited from `SymConnector` :\
` `[`destination`](../object/SymConnector.html#destination)`  `[`dirName`](../object/SymConnector.html#dirName)`  `[`inRoom1`](../object/SymConnector.html#inRoom1)`  `[`inRoom2`](../object/SymConnector.html#inRoom2)`  `[`isDestinationKnown`](../object/SymConnector.html#isDestinationKnown)`  `[`isOpen`](../object/SymConnector.html#isOpen)`  `[`room1`](../object/SymConnector.html#room1)`  `[`room1Dir`](../object/SymConnector.html#room1Dir)`  `[`room2`](../object/SymConnector.html#room2)`  `[`room2Dir`](../object/SymConnector.html#room2Dir)`  `[`rooms`](../object/SymConnector.html#rooms)`  `
...
Inherited from `SymPassage` :\
` `[`attachedDir`](../object/SymPassage.html#attachedDir)`  `[`desc`](../object/SymPassage.html#desc)`  `[`dobjFor(Enter)`](../object/SymPassage.html#dobjFor(Enter))`  `[`dobjFor(GoAlong)`](../object/SymPassage.html#dobjFor(GoAlong))`  `[`dobjFor(GoThrough)`](../object/SymPassage.html#dobjFor(GoThrough))`  `
...
Inherited from `SymConnector` :\
` `[`byRoom`](../object/SymConnector.html#byRoom)`  `[`execTravel`](../object/SymConnector.html#execTravel)`  `[`getDestination`](../object/SymConnector.html#getDestination)`  `
...
`cannotClimbDownMsg`[OVERRIDDEN]{.rem}
...
::: desc
Retuen \'down\' or \'up\' depending on whether we\'re at the upper or
lower end of the stairway.
:::
...
we\'re at, e.g. \"The stairs lead steeply \<\<byUpLo(\'down\',
\'up\')\>\> \"
:::

[]{#dobjFor(Climb)}

`dobjFor(Climb)`[OVERRIDDEN]{.rem}
...
`dobjFor(ClimbDown)`[OVERRIDDEN]{.rem}
...
`dobjFor(ClimbUp)`[OVERRIDDEN]{.rem}
...
`initConnector (loc, dir)`[OVERRIDDEN]{.rem}
