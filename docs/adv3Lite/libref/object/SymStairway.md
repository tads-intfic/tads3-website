...
`canClimbDownMe`<span class="rem">OVERRIDDEN</span>
...
`cannotClimbDownMsg`<span class="rem">OVERRIDDEN</span>
...
`cannotClimbMsg`<span class="rem">OVERRIDDEN</span>
...
`isClimbable`<span class="rem">OVERRIDDEN</span>
...
`PushTravelVia`<span class="rem">OVERRIDDEN</span>
...
`traversalMsg`<span class="rem">OVERRIDDEN</span>
...
`dobjFor(Climb)`<span class="rem">OVERRIDDEN</span>
...
`initConnector (loc, dir)`<span class="rem">OVERRIDDEN</span>
...
`sayActorFollowing (follower, leader)`<span class="rem">OVERRIDDEN</span>
