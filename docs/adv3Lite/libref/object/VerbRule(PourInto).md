...
layout: docs
---
<span class="title">VerbRule(PourInto)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PourInto)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
