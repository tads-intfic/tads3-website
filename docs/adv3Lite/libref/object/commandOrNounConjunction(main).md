[commandOrNounConjunction(main)]{.title}[grammar]{.type}
...
`grammar `**[`commandOrNounConjunction`](../object/commandOrNounConjunction.html)`(main)`**` :   `[`Production`](../object/Production.html)
:::
