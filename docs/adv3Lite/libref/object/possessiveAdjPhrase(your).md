[possessiveAdjPhrase(your)]{.title}[grammar]{.type}
...
`grammar `**[`possessiveAdjPhrase`](../object/possessiveAdjPhrase.html)`(your)`**` :   `[`PossessiveProduction`](../object/PossessiveProduction.html)
:::
