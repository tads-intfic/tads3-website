...
layout: docs
---
<span class="title">VerbRule(ScriptOn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ScriptOn)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
