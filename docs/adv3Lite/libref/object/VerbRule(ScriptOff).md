...
layout: docs
---
<span class="title">VerbRule(ScriptOff)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ScriptOff)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
