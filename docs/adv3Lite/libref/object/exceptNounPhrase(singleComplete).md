[exceptNounPhrase(singleComplete)]{.title}[grammar]{.type}
...
`grammar `**[`exceptNounPhrase`](../object/exceptNounPhrase.html)`(singleComplete)`**` :   `[`Production`](../object/Production.html)
:::
