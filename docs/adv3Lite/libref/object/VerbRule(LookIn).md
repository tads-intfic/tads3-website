...
layout: docs
---
<span class="title">VerbRule(LookIn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(LookIn)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
