[possessiveNounPhrase(its)]{.title}[grammar]{.type}
...
`grammar `**[`possessiveNounPhrase`](../object/possessiveNounPhrase.html)`(its)`**` :   `[`PossessiveProduction`](../object/PossessiveProduction.html)
:::
