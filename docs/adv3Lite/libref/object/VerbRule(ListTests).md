---
---
<span class="title">VerbRule(ListTests)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ListTests)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
