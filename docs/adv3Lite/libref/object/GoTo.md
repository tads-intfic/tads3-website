...
layout: docs
---
<span class="title">GoTo</span><span class="type">object</span>
...
**`GoTo`**` :   `[`TAction`](../object/TAction.html)
...
[`againRepeatsParse`](#againRepeatsParse)[`reportImplicitActions`](#reportImplicitActions)
...
[actions.t](../file/actions.t.html)\[[808](../source/actions.t.html#808)\]
...
`reportImplicitActions`<span class="rem">OVERRIDDEN</span>

[actions.t](../file/actions.t.html)\[[810](../source/actions.t.html#810)\]
