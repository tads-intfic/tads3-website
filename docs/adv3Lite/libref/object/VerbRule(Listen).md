...
layout: docs
---
<span class="title">VerbRule(Listen)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Listen)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
