...
layout: docs
---
<span class="title">possessiveAdjPhrase(definiteNpApostropheS)</span><span class="type">grammar</span>
...
`grammar `**[`possessiveAdjPhrase`](../object/possessiveAdjPhrase.html)`(definiteNpApostropheS)`**` :   `[`PossessiveProduction`](../object/PossessiveProduction.html)
