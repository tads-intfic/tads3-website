...
layout: docs
---
<span class="title">VerbRule(UnfastenFrom)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(UnfastenFrom)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
