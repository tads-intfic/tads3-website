[VerbRule(ShowToType2)]{.title}[grammar]{.type}
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ShowToType2)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
:::
