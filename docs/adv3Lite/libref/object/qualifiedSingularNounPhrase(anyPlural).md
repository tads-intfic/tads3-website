[qualifiedSingularNounPhrase(anyPlural)]{.title}[grammar]{.type}
...
`grammar `**[`qualifiedSingularNounPhrase`](../object/qualifiedSingularNounPhrase.html)`(anyPlural)`**` :   `[`Production`](../object/Production.html)
:::
