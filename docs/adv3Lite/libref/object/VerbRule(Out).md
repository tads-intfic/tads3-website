...
layout: docs
---
<span class="title">VerbRule(Out)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Out)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
