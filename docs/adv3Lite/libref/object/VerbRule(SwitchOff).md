...
layout: docs
---
<span class="title">VerbRule(SwitchOff)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(SwitchOff)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
