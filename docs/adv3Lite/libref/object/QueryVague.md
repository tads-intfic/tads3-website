...
` `[`curObj`](../object/MiscConvAction.html#curObj)`  `[`isConversational`](../object/MiscConvAction.html#isConversational)`  `[`topicObj`](../object/MiscConvAction.html#topicObj)`  `
