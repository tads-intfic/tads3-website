...
layout: docs
---
<span class="title">VerbRule(Write)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Write)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
