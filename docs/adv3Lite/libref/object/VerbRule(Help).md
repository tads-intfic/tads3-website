...
layout: docs
---
<span class="title">VerbRule(Help)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Help)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
