...
layout: docs
---
<span class="title">Noise</span><span class="type">class</span>

[extras.t](../file/extras.t.html)\[[86](../source/extras.t.html#86)\],
[sensory.t](../file/sensory.t.html)\[[266](../source/sensory.t.html#266)\]
...
in response to EXAMINE or LISTEN TO; any other action is responded to
with the notImportantMsg.

*Modified in
[sensory.t](../file/sensory.t.html)\[[266](../source/sensory.t.html#266)\]:*  
An Noise is a SensoryEmanation representing a Sound \[MODIFIED FOR
SENSORY EXTENSION\]
...
Inherited from `SensoryEmanation` :  
[`descWithoutSource`](../object/SensoryEmanation.html#descWithoutSource)[`descWithSource`](../object/SensoryEmanation.html#descWithSource)[`emanationState`](../object/SensoryEmanation.html#emanationState)[`isEmanating`](../object/SensoryEmanation.html#isEmanating)[`isHidden`](../object/SensoryEmanation.html#isHidden)[`lastEmanationTime`](../object/SensoryEmanation.html#lastEmanationTime)[`schedule`](../object/SensoryEmanation.html#schedule)[`scheduleState`](../object/SensoryEmanation.html#scheduleState)
...
Inherited from `SensoryEmanation` :  
[`hideFromAll`](../object/SensoryEmanation.html#hideFromAll)[`reset`](../object/SensoryEmanation.html#reset)
...
`decorationActions`<span class="rem">OVERRIDDEN</span>
...
`notImportantMsg`<span class="rem">OVERRIDDEN</span>
...
`sightSize`<span class="rem">OVERRIDDEN</span>
...
`tooFarAwayToSeeDetailMsg`<span class="rem">OVERRIDDEN</span>
...
`emanate ( )`<span class="rem">OVERRIDDEN</span>
...
`emanationDesc ( )`<span class="rem">OVERRIDDEN</span>
...
code can easily override this method if something different is required.
By default we execute our script if we are one, otherwise we use our own
