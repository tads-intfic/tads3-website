...
layout: docs
---
<span class="title">VerbRule(TalkAboutImplicit)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(TalkAboutImplicit)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
