...
layout: docs
---
<span class="title">VerbRule(LieOn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(LieOn)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
