...
layout: docs
---
<span class="title">locationPrep(on)</span><span class="type">grammar</span>
...
`grammar `**[`locationPrep`](../object/locationPrep.html)`(on)`**` :   `[`LocationPrepProduction`](../object/LocationPrepProduction.html)
