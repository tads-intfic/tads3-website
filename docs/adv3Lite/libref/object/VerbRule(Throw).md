...
layout: docs
---
<span class="title">VerbRule(Throw)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Throw)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
