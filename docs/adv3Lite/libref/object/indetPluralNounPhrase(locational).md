...
layout: docs
---
<span class="title">indetPluralNounPhrase(locational)</span><span class="type">grammar</span>
...
`grammar `**[`indetPluralNounPhrase`](../object/indetPluralNounPhrase.html)`(locational)`**` :   `[`LocationalProduction`](../object/LocationalProduction.html)
