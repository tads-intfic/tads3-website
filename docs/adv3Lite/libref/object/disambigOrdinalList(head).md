[disambigOrdinalList(head)]{.title}[grammar]{.type}
...
`grammar `**[`disambigOrdinalList`](../object/disambigOrdinalList.html)`(head)`**` :   `[`NounListProduction`](../object/NounListProduction.html)
:::
