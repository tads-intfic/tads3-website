[SceneStartTopic]{.title}[class]{.type}
...
::: fdesc
A SceneStartTopic is a topic entry that is triggered when any of the
scenes in its matchObj property starts. \[SCENETOPIC EXTENSION\]

`class `**`SceneStartTopic`**` :   `[`SceneTopic`](../object/SceneTopic.html)
:::
...
Inherited from `SceneTopic` :\
` `[`afterResponse`](../object/SceneTopic.html#afterResponse)`  `[`beforeResponse`](../object/SceneTopic.html#beforeResponse)`  `[`handleTopic`](../object/SceneTopic.html#handleTopic)`  `
