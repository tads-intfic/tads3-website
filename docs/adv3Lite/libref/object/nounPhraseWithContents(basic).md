...
layout: docs
---
<span class="title">nounPhraseWithContents(basic)</span><span class="type">grammar</span>
...
`grammar `**[`nounPhraseWithContents`](../object/nounPhraseWithContents.html)`(basic)`**` :   `[`Production`](../object/Production.html)
