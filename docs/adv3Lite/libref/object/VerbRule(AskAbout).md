---
---
<span class="title">VerbRule(AskAbout)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(AskAbout)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
