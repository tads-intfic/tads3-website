...
layout: docs
---
<span class="title">pronounPhrase(themselves)</span><span class="type">grammar</span>
...
`grammar `**[`pronounPhrase`](../object/pronounPhrase.html)`(themselves)`**` :   `[`PronounProduction`](../object/PronounProduction.html)
