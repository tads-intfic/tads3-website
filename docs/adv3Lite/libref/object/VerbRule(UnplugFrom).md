...
layout: docs
---
<span class="title">VerbRule(UnplugFrom)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(UnplugFrom)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
