...
layout: docs
---
<span class="title">VerbRule(ClimbUpWhat)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ClimbUpWhat)`**` :   `[`VerbProduction`](../object/VerbProduction.html)*`// after macro expansion`*
