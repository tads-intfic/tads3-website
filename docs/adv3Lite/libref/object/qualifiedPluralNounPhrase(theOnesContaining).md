...
layout: docs
---
<span class="title">qualifiedPluralNounPhrase(theOnesContaining)</span><span class="type">grammar</span>
...
`grammar `**[`qualifiedPluralNounPhrase`](../object/qualifiedPluralNounPhrase.html)`(theOnesContaining)`**` :   `[`ContentsQualifierProduction`](../object/ContentsQualifierProduction.html)
