...
layout: docs
---
<span class="title">VerbRule(Read)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Read)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
