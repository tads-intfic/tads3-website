...
layout: docs
---
<span class="title">literalNounPhrase(number)</span><span class="type">grammar</span>
...
`grammar `**[`literalNounPhrase`](../object/literalNounPhrase.html)`(number)`**` :   `[`Production`](../object/Production.html)
