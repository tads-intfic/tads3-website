---
---
<span class="title">VerbRule(Exits)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Exits)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
