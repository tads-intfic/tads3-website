[qualifiedPluralNounPhrase(anyNum)]{.title}[grammar]{.type}
...
`grammar `**[`qualifiedPluralNounPhrase`](../object/qualifiedPluralNounPhrase.html)`(anyNum)`**` :   `[`QuantifierProduction`](../object/QuantifierProduction.html)
:::
