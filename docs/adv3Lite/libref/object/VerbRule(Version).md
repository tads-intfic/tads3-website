...
layout: docs
---
<span class="title">VerbRule(Version)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Version)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
