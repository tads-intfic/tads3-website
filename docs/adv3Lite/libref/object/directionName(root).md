...
layout: docs
---
<span class="title">directionName(root)</span><span class="type">grammar</span>
...
`grammar `**[`directionName`](../object/directionName1.html)`(root)`**` :   `[`Production`](../object/Production.html)
