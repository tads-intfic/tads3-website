...
layout: docs
---
<span class="title">VerbRule(No)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(No)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
