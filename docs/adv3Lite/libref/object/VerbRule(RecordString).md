---
---
<span class="title">VerbRule(RecordString)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(RecordString)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
