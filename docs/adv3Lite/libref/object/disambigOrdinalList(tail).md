[disambigOrdinalList(tail)]{.title}[grammar]{.type}
...
`grammar `**[`disambigOrdinalList`](../object/disambigOrdinalList.html)`(tail)`**` :   `[`NounListProduction`](../object/NounListProduction.html)
:::
