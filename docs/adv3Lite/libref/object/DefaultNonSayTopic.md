...
layout: docs
---
<span class="title">DefaultNonSayTopic</span><span class="type">class</span>
...
A DefaultConversationTopic is a DefaultConverationTopic that matches any
strictly conversational command apart from SAY.

`class `**`DefaultNonSayTopic`**` :   `[`DefaultConversationTopic`](../object/DefaultConversationTopic.html)
