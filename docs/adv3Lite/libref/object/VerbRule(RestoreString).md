...
layout: docs
---
<span class="title">VerbRule(RestoreString)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(RestoreString)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
