...
layout: docs
---
<span class="title">Hints</span><span class="type">object</span>
...
**`Hints`**` :   `[`SystemAction`](../object/SystemAction.html)
...
[`execAction`](#execAction) [`sayHintsNotPresent`](#sayHintsNotPresent)
...
[actions.t](../file/actions.t.html)\[[307](../source/actions.t.html#307)\]
...
<span id="sayHintsNotPresent"></span>

`sayHintsNotPresent ( )`

[actions.t](../file/actions.t.html)\[[316](../source/actions.t.html#316)\]
