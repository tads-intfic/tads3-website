...
layout: docs
---
<span class="title">VerbRule(PutBehind)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PutBehind)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
