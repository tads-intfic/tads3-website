...
layout: docs
---
<span class="title">DefaultSayTopic</span><span class="type">class</span>
...
`class `**`DefaultSayTopic`**` :   `[`DefaultTopic`](../object/DefaultTopic.html)
...
[`includeInList`](#includeInList) [`matchScore`](#matchScore) [`topicResponse`](#topicResponse)
