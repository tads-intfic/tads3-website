[nonTerminalNounMultiList(multi)]{.title}[grammar]{.type}
...
`grammar `**[`nonTerminalNounMultiList`](../object/nonTerminalNounMultiList.html)`(multi)`**` :   `[`NounListProduction`](../object/NounListProduction.html)
:::
