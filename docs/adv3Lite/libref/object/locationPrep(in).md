...
layout: docs
---
<span class="title">locationPrep(in)</span><span class="type">grammar</span>
...
`grammar `**[`locationPrep`](../object/locationPrep.html)`(in)`**` :   `[`LocationPrepProduction`](../object/LocationPrepProduction.html)
