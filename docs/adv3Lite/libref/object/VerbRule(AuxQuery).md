[VerbRule(AuxQuery)]{.title}[grammar]{.type}
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(AuxQuery)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
:::
...
` `[`action`](#action)`  `[`missingQ`](#missingQ)`  `[`priority`](#priority)`  `[`qtype`](#qtype)`  `
