...
layout: docs
---
<span class="title">VerbRule(Inventory)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Inventory)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
