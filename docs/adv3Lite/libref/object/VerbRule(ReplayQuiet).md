...
layout: docs
---
<span class="title">VerbRule(ReplayQuiet)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ReplayQuiet)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
...
` [`action`](#action)  [`scriptOptionFlags`](#scriptOptionFlags)  `
