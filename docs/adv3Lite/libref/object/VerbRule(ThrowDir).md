...
layout: docs
---
<span class="title">VerbRule(ThrowDir)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ThrowDir)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
