---
---
<span class="title">VerbRule(Move)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Move)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
