---
---
<span class="title">literalNounPhrase(string)</span><span class="type">grammar</span>
...
`grammar `**[`literalNounPhrase`](../object/literalNounPhrase.html)`(string)`**` :   `[`Production`](../object/Production.html)
