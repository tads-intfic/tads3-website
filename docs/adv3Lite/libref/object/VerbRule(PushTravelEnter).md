...
layout: docs
---
<span class="title">VerbRule(PushTravelEnter)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PushTravelEnter)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
