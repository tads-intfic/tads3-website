...
layout: docs
---
<span class="title">VerbRule(FullScore)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(FullScore)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
