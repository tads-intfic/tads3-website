...
layout: docs
---
<span class="title">exceptListBody(single)</span><span class="type">grammar</span>
...
`grammar `**[`exceptListBody`](../object/exceptListBody.html)`(single)`**` :   `[`Production`](../object/Production.html)
