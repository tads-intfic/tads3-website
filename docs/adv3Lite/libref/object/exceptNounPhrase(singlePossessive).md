[exceptNounPhrase(singlePossessive)]{.title}[grammar]{.type}
...
`grammar `**[`exceptNounPhrase`](../object/exceptNounPhrase.html)`(singlePossessive)`**` :   `[`Production`](../object/Production.html)
:::
