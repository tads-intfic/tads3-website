---
---
<span class="title">VerbRule(FootnotesMedium)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(FootnotesMedium)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
