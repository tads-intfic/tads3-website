...
layout: docs
---
<span class="title">VerbRule(Jump)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Jump)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
