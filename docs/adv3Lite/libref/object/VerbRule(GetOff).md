---
---
<span class="title">VerbRule(GetOff)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(GetOff)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
