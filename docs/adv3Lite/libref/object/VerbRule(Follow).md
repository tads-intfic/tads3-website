...
layout: docs
---
<span class="title">VerbRule(Follow)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Follow)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
