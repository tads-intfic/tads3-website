---
---
<span class="title">VerbRule(Again)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Again)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
