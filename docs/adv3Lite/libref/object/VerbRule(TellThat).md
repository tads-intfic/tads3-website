...
layout: docs
---
<span class="title">VerbRule(TellThat)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(TellThat)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
