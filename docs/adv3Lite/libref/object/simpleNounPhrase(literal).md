---
---
<span class="title">simpleNounPhrase(literal)</span><span class="type">grammar</span>
...
`grammar `**[`simpleNounPhrase`](../object/simpleNounPhrase.html)`(literal)`**` :   `[`Production`](../object/Production.html)
