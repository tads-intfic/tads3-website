...
layout: docs
---
<span class="title">numberObjPhrase(main)</span><span class="type">grammar</span>
...
`grammar `**[`numberObjPhrase`](../object/numberObjPhrase.html)`(main)`**` :   `[`NumberNounProduction`](../object/NumberNounProduction.html)
