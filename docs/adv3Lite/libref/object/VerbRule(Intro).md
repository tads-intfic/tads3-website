...
layout: docs
---
<span class="title">VerbRule(Intro)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Intro)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
