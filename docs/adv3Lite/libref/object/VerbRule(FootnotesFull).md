---
---
<span class="title">VerbRule(FootnotesFull)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(FootnotesFull)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
