...
layout: docs
---
<span class="title">pronounPhrase(us)</span><span class="type">grammar</span>
...
`grammar `**[`pronounPhrase`](../object/pronounPhrase.html)`(us)`**` :   `[`PronounProduction`](../object/PronounProduction.html)
