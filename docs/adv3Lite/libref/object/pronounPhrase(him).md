...
layout: docs
---
<span class="title">pronounPhrase(him)</span><span class="type">grammar</span>
...
`grammar `**[`pronounPhrase`](../object/pronounPhrase.html)`(him)`**` :   `[`PronounProduction`](../object/PronounProduction.html)
