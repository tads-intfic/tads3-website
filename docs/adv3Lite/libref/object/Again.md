---
---
<span class="title">Again</span><span class="type">object</span>
...
**`Again`**` :   `[`SystemAction`](../object/SystemAction.html)
...
` `[`clearForAgain`](#clearForAgain)`  `[`exec`](#exec)`  `

Inherited from `SystemAction` :  
` `[`afterAction`](../object/SystemAction.html#afterAction)`  `[`execCycle`](../object/SystemAction.html#execCycle)`  `[`getInputFile`](../object/SystemAction.html#getInputFile)`  `[`turnSequence`](../object/SystemAction.html#turnSequence)`  `
...
[actions.t](../file/actions.t.html)\[[3014](../source/actions.t.html#3014)\]
