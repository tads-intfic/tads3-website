[possessiveAdjPhrase(my)]{.title}[grammar]{.type}
...
`grammar `**[`possessiveAdjPhrase`](../object/possessiveAdjPhrase.html)`(my)`**` :   `[`PossessiveProduction`](../object/PossessiveProduction.html)
:::
