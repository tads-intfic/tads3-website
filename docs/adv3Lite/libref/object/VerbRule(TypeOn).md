---
---
<span class="title">VerbRule(TypeOn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(TypeOn)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
