---
---
<span class="title">VerbRule(In)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(In)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
