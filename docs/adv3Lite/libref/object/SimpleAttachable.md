...
attached objects are located in the object to which they are attached.
...
`canAttachToMe`<span class="rem">OVERRIDDEN</span>
...
`canDetachFromMe`<span class="rem">OVERRIDDEN</span>
...
`cannotDetachFromMsg`<span class="rem">OVERRIDDEN</span>
...
`cannotDetachMsg`<span class="rem">OVERRIDDEN</span>
...
`isAttachable`<span class="rem">OVERRIDDEN</span>
...
`isDetachable`<span class="rem">OVERRIDDEN</span>
...
`actionMoveInto (loc)`<span class="rem">OVERRIDDEN</span>
...
`dobjFor(DetachFrom)`<span class="rem">OVERRIDDEN</span>
...
`dobjFor(FastenTo)`<span class="rem">OVERRIDDEN</span>
...
`dobjFor(Unfasten)`<span class="rem">OVERRIDDEN</span>
...
`dobjFor(UnfastenFrom)`<span class="rem">OVERRIDDEN</span>
...
`iobjFor(FastenTo)`<span class="rem">OVERRIDDEN</span>
...
`iobjFor(UnfastenFrom)`<span class="rem">OVERRIDDEN</span>
...
`locType ( )`<span class="rem">OVERRIDDEN</span>
