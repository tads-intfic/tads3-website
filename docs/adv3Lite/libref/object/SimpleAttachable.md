[SimpleAttachable]{.title}[class]{.type}
...
`canDetachFromMe`[OVERRIDDEN]{.rem}
...
`cannotDetachFromMsg`[OVERRIDDEN]{.rem}
...
`cannotDetachMsg`[OVERRIDDEN]{.rem}
...
`actionMoveInto (loc)`[OVERRIDDEN]{.rem}
...
`dobjFor(AttachTo)`[OVERRIDDEN]{.rem}
...
`dobjFor(DetachFrom)`[OVERRIDDEN]{.rem}
...
`dobjFor(FastenTo)`[OVERRIDDEN]{.rem}
...
`dobjFor(Unfasten)`[OVERRIDDEN]{.rem}
...
`dobjFor(UnfastenFrom)`[OVERRIDDEN]{.rem}
...
`iobjFor(AttachTo)`[OVERRIDDEN]{.rem}
...
`iobjFor(DetachFrom)`[OVERRIDDEN]{.rem}
...
`iobjFor(FastenTo)`[OVERRIDDEN]{.rem}
...
`iobjFor(UnfastenFrom)`[OVERRIDDEN]{.rem}
