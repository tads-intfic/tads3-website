...
`grammar `**[`nonTerminalNounMultiList`](../object/nonTerminalNounMultiList.html)`(pair)`**` :   `[`NounListProduction`](../object/NounListProduction.html)
...
Inherited from `NounListProduction` :  
[`visitProd`](../object/NounListProduction.html#visitProd)
