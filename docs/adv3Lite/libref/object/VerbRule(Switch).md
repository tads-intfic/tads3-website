---
---
<span class="title">VerbRule(Switch)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Switch)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
