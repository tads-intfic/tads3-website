[possessiveNounPhrase(npApostropheS)]{.title}[grammar]{.type}
...
`grammar `**[`possessiveNounPhrase`](../object/possessiveNounPhrase.html)`(npApostropheS)`**` :   `[`PossessiveProduction`](../object/PossessiveProduction.html)
:::
