...
layout: docs
---
<span class="title">pronounPhrase(her)</span><span class="type">grammar</span>
...
`grammar `**[`pronounPhrase`](../object/pronounPhrase.html)`(her)`**` :   `[`PronounProduction`](../object/PronounProduction.html)
