...
layout: docs
---
<span class="title">VerbRule(SmellSomething)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(SmellSomething)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
