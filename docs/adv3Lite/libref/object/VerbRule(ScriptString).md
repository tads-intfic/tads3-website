...
layout: docs
---
<span class="title">VerbRule(ScriptString)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ScriptString)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
