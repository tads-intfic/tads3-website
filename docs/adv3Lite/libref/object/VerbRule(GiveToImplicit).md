...
layout: docs
---
<span class="title">VerbRule(GiveToImplicit)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(GiveToImplicit)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
