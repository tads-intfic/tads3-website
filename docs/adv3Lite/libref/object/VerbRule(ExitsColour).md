...
layout: docs
---
<span class="title">VerbRule(ExitsColour)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ExitsColour)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
