...
layout: docs
---
<span class="title">VerbRule(WhoAmI)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(WhoAmI)`**` :   [`VerbProduction`](../object/VerbProduction.html)      `*`// after macro expansion`*
