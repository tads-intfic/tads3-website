[aboutTopicPhrase(main)]{.title}[grammar]{.type}
...
`grammar `**[`aboutTopicPhrase`](../object/aboutTopicPhrase.html)`(main)`**` :   `[`TopicNounProduction`](../object/TopicNounProduction.html)
:::
...
Inherited from `TopicNounProduction` :\
` `[`npClass`](../object/TopicNounProduction.html#npClass)`  `
