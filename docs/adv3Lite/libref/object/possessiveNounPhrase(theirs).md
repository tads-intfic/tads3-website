[possessiveNounPhrase(theirs)]{.title}[grammar]{.type}
...
`grammar `**[`possessiveNounPhrase`](../object/possessiveNounPhrase.html)`(theirs)`**` :   `[`PossessiveProduction`](../object/PossessiveProduction.html)
:::
