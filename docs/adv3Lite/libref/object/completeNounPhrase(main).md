...
layout: docs
---
<span class="title">completeNounPhrase(main)</span><span class="type">grammar</span>
...
`grammar `**[`completeNounPhrase`](../object/completeNounPhrase.html)`(main)`**` :   `[`Production`](../object/Production.html)
