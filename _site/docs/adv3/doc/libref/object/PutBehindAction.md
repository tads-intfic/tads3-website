<span class="title">PutBehindAction</span><span class="type">class</span>
...
`DefineTIAction(PutBehind)      `*`// original source text`*  
`class `**`PutBehindAction`**` :   `[`TIAction`](../object/TIAction.html)`      `*`// after macro expansion`*
