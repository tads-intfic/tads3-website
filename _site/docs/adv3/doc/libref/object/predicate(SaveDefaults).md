<span class="title">predicate(SaveDefaults)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(SaveDefaults)`</span>` :   `[`SaveDefaultsAction`](../object/SaveDefaultsAction.html)`      `*`// after macro expansion`*
