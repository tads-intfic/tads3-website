<span class="title">predicate(Screw)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Screw)`</span>` :   `[`ScrewAction`](../object/ScrewAction.html)`      `*`// after macro expansion`*
