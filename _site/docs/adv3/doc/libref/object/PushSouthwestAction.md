<span class="title">PushSouthwestAction</span><span class="type">class</span>
...
`DefineAction(PushSouthwest, PushTravelDirAction)      `*`// original source text`*  
`class `**`PushSouthwestAction`**` :   `[`PushTravelDirAction`](../object/PushTravelDirAction.html)`      `*`// after macro expansion`*
