<span class="title">TypeLiteralOnAction</span><span class="type">class</span>
...
`DefineLiteralTAction(TypeLiteralOn, DirectObject)      `*`// original source text`*  
`class `**`TypeLiteralOnAction`**` :   `[`LiteralTAction`](../object/LiteralTAction.html)`      `*`// after macro expansion`*
