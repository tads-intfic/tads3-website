<span class="title">predicate(AttackWith)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(AttackWith)`</span>` :   `[`AttackWithAction`](../object/AttackWithAction.html)`      `*`// after macro expansion`*
...
Inherited from `AttackWithAction` :  
` `[`getAllIobj`](../object/AttackWithAction.html#getAllIobj)`  `
