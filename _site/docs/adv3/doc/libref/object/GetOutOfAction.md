<span class="title">GetOutOfAction</span><span class="type">class</span>
...
`DefineTAction(GetOutOf)      `*`// original source text`*  
`class `**`GetOutOfAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
