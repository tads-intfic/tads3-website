<span class="title">predicate(ClimbDown)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(ClimbDown)`</span>` :   `[`ClimbDownAction`](../object/ClimbDownAction.html)`      `*`// after macro expansion`*
