<span class="title">ThrowAtAction</span><span class="type">class</span>
...
`DefineTIAction(ThrowAt)      `*`// original source text`*  
`class `**`ThrowAtAction`**` :   `[`TIAction`](../object/TIAction.html)`      `*`// after macro expansion`*
