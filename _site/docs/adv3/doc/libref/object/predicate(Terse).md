<span class="title">predicate(Terse)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Terse)`</span>` :   `[`TerseAction`](../object/TerseAction.html)`      `*`// after macro expansion`*
