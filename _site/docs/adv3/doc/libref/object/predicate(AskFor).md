<span class="title">predicate(AskFor)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(AskFor)`</span>` :   `[`AskForAction`](../object/AskForAction.html)`      `*`// after macro expansion`*
