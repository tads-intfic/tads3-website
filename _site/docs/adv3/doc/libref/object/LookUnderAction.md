<span class="title">LookUnderAction</span><span class="type">class</span>
...
`DefineTAction(LookUnder)      `*`// original source text`*  
`class `**`LookUnderAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
