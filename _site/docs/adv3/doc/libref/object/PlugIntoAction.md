<span class="title">PlugIntoAction</span><span class="type">class</span>
...
`DefineTIAction(PlugInto)      `*`// original source text`*  
`class `**`PlugIntoAction`**` :   `[`TIAction`](../object/TIAction.html)`      `*`// after macro expansion`*
