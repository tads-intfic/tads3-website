<span class="title">DigWithAction</span><span class="type">class</span>
...
`DefineTIAction(DigWith)      `*`// original source text`*  
`class `**`DigWithAction`**` :   `[`TIAction`](../object/TIAction.html)`      `*`// after macro expansion`*
