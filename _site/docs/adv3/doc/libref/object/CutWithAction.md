<span class="title">CutWithAction</span><span class="type">class</span>
...
`DefineTIAction(CutWith)      `*`// original source text`*  
`class `**`CutWithAction`**` :   `[`TIAction`](../object/TIAction.html)`      `*`// after macro expansion`*
