<span class="title">ClimbDownAction</span><span class="type">class</span>
...
`DefineTAction(ClimbDown)      `*`// original source text`*  
`class `**`ClimbDownAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
