<span class="title">predicate(AttachTo)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(AttachTo)`</span>` :   `[`AttachToAction`](../object/AttachToAction.html)`      `*`// after macro expansion`*
