<span class="title">TakeAction</span><span class="type">class</span>
...
`DefineTAction(Take)      `*`// original source text`*  
`class `**`TakeAction`**` :   `[`TAction`](../object/TAction.html)`      `*`// after macro expansion`*
