<span class="title">predicate(Quit)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(Quit)`</span>` :   `[`QuitAction`](../object/QuitAction.html)`      `*`// after macro expansion`*
