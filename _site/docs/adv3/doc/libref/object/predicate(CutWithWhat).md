<span class="title">predicate(CutWithWhat)</span><span class="type">grammar</span>
...
`grammar `<span class="gramalt">[`predicate`](../object/predicate.html)`(CutWithWhat)`</span>` :   `[`CutWithAction`](../object/CutWithAction.html)`      `*`// after macro expansion`*
