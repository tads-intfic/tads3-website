...
<a href="builtins.htm" class="nav">The Intrinsics</a> \> tads-net
Function Set  
<span class="navnp"><a href="tadsio.htm" class="nav"><em>Prev:</em> tads-io Function Set</a>
    <a href="netsec.htm" class="nav"><em>Next:</em> Network Safety</a>
    </span>
...
server, such as an [HTTPServer](httpsrv.htm) object, because it tells
...
- <span id="NetEvRequest"><span class="code">NetEvRequest</span></span> -
  ...
  - For an HTTP request, the <span class="code">evRequest</span> value
    is an object of intrinsic class [HTTPRequest](httpreq.htm).
...
- <span id="NetEvReplyDone"><span class="code">NetEvReplyDone</span></span> -
  ...
  **NetReplyDoneEvent**, which has the following properties and methods:
  - <span class="code">requestObj</span> - the original request object
    ...
    [HTTPRequest](httpreq.htm) object in the case of an HTTP request)
