<span class="title">VerbRule(FootnotesStatus)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(FootnotesStatus)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
