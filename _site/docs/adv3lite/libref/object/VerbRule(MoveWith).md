<span class="title">VerbRule(MoveWith)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(MoveWith)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
