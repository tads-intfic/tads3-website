<span class="title">VerbRule(ListenTo)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ListenTo)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
