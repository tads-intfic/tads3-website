<span class="title">VerbRule(Hello)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Hello)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
