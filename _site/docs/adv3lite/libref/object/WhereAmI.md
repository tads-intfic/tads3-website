<span class="title">WhereAmI</span><span class="type">object</span>
...
Trap commands like WHERE AM I or WHERE ARE WE or WHAT IS HERE. Perform a
LOOK command but explain that LOOK is the phrasing to use.

**`WhereAmI`**` :   `[`IAction`](../object/IAction.html)
...
[newbie.t](../file/newbie.t.html)\[[799](../source/newbie.t.html#799)\]
