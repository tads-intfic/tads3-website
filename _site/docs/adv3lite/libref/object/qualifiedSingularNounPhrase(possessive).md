<span class="title">qualifiedSingularNounPhrase(possessive)</span><span class="type">grammar</span>
...
`grammar `**[`qualifiedSingularNounPhrase`](../object/qualifiedSingularNounPhrase.html)`(possessive)`**` :   `[`Production`](../object/Production.html)
