<span class="title">VerbRule(Continue)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Continue)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
