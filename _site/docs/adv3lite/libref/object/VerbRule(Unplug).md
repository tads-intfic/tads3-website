<span class="title">VerbRule(Unplug)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Unplug)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
