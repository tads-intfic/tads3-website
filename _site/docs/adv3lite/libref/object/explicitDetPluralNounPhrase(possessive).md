<span class="title">explicitDetPluralNounPhrase(possessive)</span><span class="type">grammar</span>
...
`grammar `**[`explicitDetPluralNounPhrase`](../object/explicitDetPluralNounPhrase.html)`(possessive)`**` :   `[`Production`](../object/Production.html)
