<span class="title">VerbRule(Stand)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Stand)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
