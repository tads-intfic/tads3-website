<span class="title">locationPrep(from)</span><span class="type">grammar</span>
...
`grammar `**[`locationPrep`](../object/locationPrep.html)`(from)`**` :   `[`LocationPrepProduction`](../object/LocationPrepProduction.html)
