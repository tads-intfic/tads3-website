<span class="title">VerbRule(InventoryWide)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(InventoryWide)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
