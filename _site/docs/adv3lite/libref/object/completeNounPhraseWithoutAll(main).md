<span class="title">completeNounPhraseWithoutAll(main)</span><span class="type">grammar</span>
...
`grammar `**[`completeNounPhraseWithoutAll`](../object/completeNounPhraseWithoutAll.html)`(main)`**` :   `[`Production`](../object/Production.html)
