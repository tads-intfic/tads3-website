<span class="title">pronounPhrase(itself)</span><span class="type">grammar</span>
...
`grammar `**[`pronounPhrase`](../object/pronounPhrase.html)`(itself)`**` :   `[`PronounProduction`](../object/PronounProduction.html)
