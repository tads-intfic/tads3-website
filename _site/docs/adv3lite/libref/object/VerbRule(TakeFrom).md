<span class="title">VerbRule(TakeFrom)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(TakeFrom)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
