<span class="title">VerbRule(Pull)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Pull)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
