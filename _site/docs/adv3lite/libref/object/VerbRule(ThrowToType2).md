<span class="title">VerbRule(ThrowToType2)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ThrowToType2)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
