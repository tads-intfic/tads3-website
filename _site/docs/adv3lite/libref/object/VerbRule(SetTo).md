<span class="title">VerbRule(SetTo)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(SetTo)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
