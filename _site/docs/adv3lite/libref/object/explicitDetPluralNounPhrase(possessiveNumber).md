...
`grammar `**[`explicitDetPluralNounPhrase`](../object/explicitDetPluralNounPhrase.html)`(possessiveNumber)`**` :   `[`QuantifierProduction`](../object/QuantifierProduction.html)
...
the possessive makes this definite: BOB'S FIVE BOOKS implies that Bob
has EXACTLY five books
