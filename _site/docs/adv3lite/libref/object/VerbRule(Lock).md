<span class="title">VerbRule(Lock)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(Lock)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
