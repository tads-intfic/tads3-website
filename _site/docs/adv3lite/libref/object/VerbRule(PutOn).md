<span class="title">VerbRule(PutOn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(PutOn)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
