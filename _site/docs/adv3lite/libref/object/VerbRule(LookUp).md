<span class="title">VerbRule(LookUp)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(LookUp)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
