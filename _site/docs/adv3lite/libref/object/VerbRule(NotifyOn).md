<span class="title">VerbRule(NotifyOn)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(NotifyOn)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
