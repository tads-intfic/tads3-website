<span class="title">VerbRule(DigWith)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(DigWith)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
