<span class="title">pronounPhrase(herself)</span><span class="type">grammar</span>
...
`grammar `**[`pronounPhrase`](../object/pronounPhrase.html)`(herself)`**` :   `[`PronounProduction`](../object/PronounProduction.html)
