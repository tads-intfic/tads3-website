<span class="title">VerbRule(ExtraHints)</span><span class="type">grammar</span>
...
`grammar `**[`VerbRule`](../object/VerbRule.html)`(ExtraHints)`**` :   `[`VerbProduction`](../object/VerbProduction.html)`      `*`// after macro expansion`*
